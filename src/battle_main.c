...
const struct TrainerBall gTrainerBallTable[] = {
    ...
    {TRAINER_CLASS_FAIRY_TALE_GIRL, ITEM_POKE_BALL},
    {TRAINER_CLASS_DELINQUENT, ITEM_DUSK_BALL},
    {TRAINER_CLASS_STREET_THUG, ITEM_DUSK_BALL},
    {TRAINER_CLASS_LORE_KEEPER, ITEM_ULTRA_BALL},
    {0xFF, ITEM_POKE_BALL},
};
