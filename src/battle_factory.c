...
static const u16 sMoves_TotalPreparation[] =
{
    ...
    MOVE_TAILWIND, MOVE_ACUPRESSURE, MOVE_ROCK_POLISH, MOVE_NASTY_PLOT, MOVE_DEFEND_ORDER, MOVE_HONE_CLAWS, MOVE_AUTOTOMIZE, 
    MOVE_QUIVER_DANCE, MOVE_COIL, MOVE_SHELL_SMASH, MOVE_SHIFT_GEAR, MOVE_WORK_UP, MOVE_COTTON_GUARD, MOVE_MAGNETIC_FLUX, 
    MOVE_POWER_UP_PUNCH, MOVE_CHARGE_BEAM, MOVE_GEAR_UP, MOVE_SERPENT_DANCE, 
    MOVE_NONE
};
...
static const u16 sMoves_ImpossibleToPredict[] =
{
    ...
    MOVE_ME_FIRST, MOVE_COPYCAT, MOVE_ENTRAINMENT, MOVE_REFLECT_TYPE, MOVE_TRICK_OR_TREAT, MOVE_ION_DELUGE, MOVE_FORESTS_CURSE,
    MOVE_TOPSY_TURVY, MOVE_ELECTRIFY, MOVE_SPEED_SWAP, 
    MOVE_NONE
};

static const u16 sMoves_WeakeningTheFoe[] =
{
    MOVE_SAND_ATTACK, MOVE_TAIL_WHIP, MOVE_LEER, MOVE_GROWL, MOVE_STRING_SHOT, MOVE_SCREECH, MOVE_SMOKESCREEN, MOVE_KINESIS, MOVE_BUBBLE_BEAM,
    MOVE_FLASH, MOVE_COTTON_SPORE, MOVE_SPITE, MOVE_SCARY_FACE, MOVE_CHARM, MOVE_KNOCK_OFF, MOVE_SWEET_SCENT, MOVE_FEATHER_DANCE,
    MOVE_FAKE_TEARS, MOVE_METAL_SOUND, MOVE_TICKLE, MOVE_GASTRO_ACID, MOVE_ACID_SPRAY, MOVE_ROCK_SMASH, MOVE_SNARL, MOVE_ELECTROWEB,
    MOVE_NOBLE_ROAR, MOVE_PARTING_SHOT, MOVE_PLAY_NICE, MOVE_CONFIDE, MOVE_EERIE_IMPULSE, MOVE_VENOM_DRENCH, MOVE_LUNGE, MOVE_FIRE_LASH, 
    MOVE_TROP_KICK, MOVE_BREAKING_SWIPE, 
    MOVE_NONE
};
...
static const u16 sMoves_HighRiskHighReturn[] =
{
    ...
    MOVE_CLOSE_COMBAT, MOVE_FLARE_BLITZ, MOVE_GIGA_IMPACT, MOVE_DRACO_METEOR, MOVE_LEAF_STORM, MOVE_ROCK_WRECKER, 
    MOVE_WOOD_HAMMER, MOVE_HEAD_SMASH, MOVE_ROAR_OF_TIME, MOVE_WILD_CHARGE, MOVE_HEAD_CHARGE, MOVE_BURN_UP, 
    MOVE_CLANGING_SCALES, MOVE_MISTY_EXPLOSION, MOVE_BLAZE_IMPACT, 
    MOVE_NONE
};
...
static const u16 sMoves_Endurance[] =
{
    ...
    MOVE_MUD_SPORT, MOVE_SLACK_OFF, MOVE_AROMATHERAPY, MOVE_WATER_SPORT, MOVE_ROOST, MOVE_HEALING_WISH, MOVE_HEAL_ORDER,
    MOVE_LUNAR_DANCE, MOVE_HEAL_PULSE, MOVE_PARABOLIC_CHARGE, MOVE_DRAINING_KISS, MOVE_SPIKY_SHIELD, MOVE_FLORAL_HEALING,
    MOVE_STRENGTH_SAP, MOVE_POLLEN_PUFF, MOVE_PURIFY, MOVE_AURORA_VEIL, MOVE_LIFE_DEW, MOVE_SINGULARITY, 
    MOVE_NONE
};
...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_TOXIC_SPIKES, MOVE_AQUA_RING, MOVE_STEALTH_ROCK, MOVE_WIDE_GUARD, MOVE_QUICK_GUARD, MOVE_STICKY_WEB, MOVE_CRAFTY_SHIELD, 
    MOVE_FAIRY_LOCK, MOVE_KINGS_SHIELD, MOVE_NUZZLE, MOVE_BANEFUL_BUNKER, MOVE_TOXIC_THREAD, MOVE_HIDDEN_THORNS, 
    MOVE_NONE
};

static const u16 sMoves_DependsOnTheBattlesFlow[] =
{
    MOVE_SANDSTORM, MOVE_RAIN_DANCE, MOVE_SUNNY_DAY, MOVE_HAIL, MOVE_WEATHER_BALL, MOVE_TRICK_ROOM, MOVE_WONDER_ROOM, MOVE_MAGIC_ROOM,
    MOVE_GRASSY_TERRAIN, MOVE_MISTY_TERRAIN, MOVE_ELECTRIC_TERRAIN, MOVE_PSYCHIC_TERRAIN, 
    MOVE_NONE
};
...
{
    // Level 50
    {FRONTIER_MON_PICHU,      FRONTIER_MON_YANMA},
    {FRONTIER_MON_DELCATTY_1, FRONTIER_MON_CLOYSTER_1},
    {FRONTIER_MON_DELCATTY_2, FRONTIER_MON_CLOYSTER_2},
    {FRONTIER_MON_DUGTRIO_1,  FRONTIER_MON_SLAKING_1},
    {FRONTIER_MON_DUGTRIO_2,  FRONTIER_MON_SLAKING_2},
    {FRONTIER_MON_DUGTRIO_3,  FRONTIER_MON_SLAKING_3},
    {FRONTIER_MON_DUGTRIO_4,  FRONTIER_MON_SLAKING_4},
    {FRONTIER_MON_DUGTRIO_1,  FRONTIER_MONS_HIGH_TIER},
    ...
    {FRONTIER_MON_DUGTRIO_3, FRONTIER_MON_SLAKING_3},
    {FRONTIER_MON_DUGTRIO_4, FRONTIER_MON_SLAKING_4},
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS_NON_UBERS - 1},
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS_NON_UBERS - 1},
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS_NON_UBERS - 1},
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS_NON_UBERS - 1},
};
...
static void GenerateOpponentMons(void)
{
    ...
    while (i != FRONTIER_PARTY_SIZE)
    {
        ...
        for (k = firstMonId; k < firstMonId + i; k++)
        {
            if (heldItems[k] != 0 && heldItems[k] == gFacilityTrainerMons[monId].item)
                break;
        }
        if (k != firstMonId + i)
            continue;
        ...
        heldItems[i] = gFacilityTrainerMons[monId].item;
...
static void SetRentalsToOpponentParty(void)
{
    ...
    for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
    {
        ...
        SetMonData(&gEnemyParty[i], MON_DATA_HELD_ITEM, &gFacilityTrainerMons[gFrontierTempParty[i]].item);
    }
}
...
static void SetPlayerAndOpponentParties(void)
{
    ...
    if (gSpecialVar_0x8005 < 2)
    {
        ...
        for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
        {
            ...
            SetMonData(&gPlayerParty[i], MON_DATA_HELD_ITEM, &gFacilityTrainerMons[monId].item);
        }
    }
    ...
    case 2:
        for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
        {
            ...
            SetMonData(&gEnemyParty[i], MON_DATA_HELD_ITEM, &gFacilityTrainerMons[monId].item);
        }
        break;
    }
}
...
static void GenerateInitialRentalMons(void)
{
    ...
    while (i != PARTY_SIZE)
    {
        ...
        for (j = firstMonId; j < firstMonId + i; j++)
        {
            if (heldItems[j] != 0 && heldItems[j] == gFacilityTrainerMons[monId].item)
            {
...
static void RestorePlayerPartyHeldItems(void)
{
    ...
    for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
    {
        SetMonData(&gPlayerParty[i],
                   MON_DATA_HELD_ITEM,
                   &gFacilityTrainerMons[gSaveBlock2Ptr->frontier.rentalMons[i].monId].item);
    }
}
