...
static const u16 sPickupItemsLvl50[TOTAL_ROUNDS][PICKUP_ITEMS_PER_ROUND] =
{
    ...
    {ITEM_MAX_POTION, ITEM_X_ATTACK, ITEM_RAWST_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_SASH, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    ...
    {ITEM_MAX_POTION, ITEM_X_SP_ATK, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_SASH, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    ...
    {ITEM_MAX_POTION, ITEM_X_ATTACK, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_SASH, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_MAX_POTION, ITEM_X_DEFENSE, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
...
static const u16 sPickupItemsLvl50BattleBagOn[TOTAL_ROUNDS][PICKUP_ITEMS_PER_ROUND] =
{
    ...
    {ITEM_MAX_POTION, ITEM_SITRUS_BERRY, ITEM_RAWST_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_SASH, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    ...
    {ITEM_MAX_POTION, ITEM_SITRUS_BERRY, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_SASH, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_MAX_POTION, ITEM_SITRUS_BERRY, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_FLUFFY_TAIL, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_MAX_POTION, ITEM_SITRUS_BERRY, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_SITRUS_BERRY, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_SASH, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
