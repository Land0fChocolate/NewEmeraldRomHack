...
static const u8 sBerryDescriptionPart2_Lum[] = _("care, it may yield over two Berries.");
...
static const u8 sBerryDescriptionPart1_Pomeg[] = _("A vibrant berry with tasty flesh");
static const u8 sBerryDescriptionPart2_Pomeg[] = _("beneath a bitter rind.");
