...
static const u8 sTileBitAttributes[] =
{
    ...
    [MB_STRENGTH_BUTTON] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
...
bool8 MetatileBehavior_IsSweetShopShelf(u8 metatileBehavior)
{
    if (metatileBehavior == MB_SWEET_SHOP_SHELF)
        return TRUE;
    else
        return FALSE;
}
