...
bool32 ShouldDoBirchNewAreasReportCall(void)
{
    if (FlagGet(FLAG_BIRCH_CALL_NEW_AREAS_REPORT))
    {
        switch (gMapHeader.mapType)
        {
            case MAP_TYPE_TOWN:
            ...
            case MAP_TYPE_ROUTE:
            case MAP_TYPE_OCEAN_ROUTE:
                if (++(*GetVarPointer(VAR_BIRCH_CALL_STEP_COUNTER)) < 10)
                {
                    return FALSE;
                }
                break;
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] = 
{
    ...
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] = 
    {
        ...
        gText_IcePunch16BP,
        gText_ThunderPunch16BP,
        gText_FirePunch16BP,
        gText_FlintBlade16BP,
        gText_SignalBeam16BP,
        gText_ZenHeadbutt16BP,
        gText_HeatWave16BP,
        gText_EarthPower20BP,
        gText_BodyPress20BP,
        gText_GunkShot20BP,
        gText_NastyPlot20BP,
        gText_Exit
