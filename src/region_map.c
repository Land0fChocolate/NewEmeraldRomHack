...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_ROYAL_REST,                 MAPSEC_ROUTE_111},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_CRUMBLING_GORGE:
        return FlagGet(FLAG_LANDMARK_CRUMBLING_GORGE) ? MAPSECTYPE_ROUTE : MAPSECTYPE_NONE;
    case MAPSEC_LITTLEROOT_BEACH:
        return FlagGet(FLAG_LANDMARK_LITTLEROOT_BEACH) ? MAPSECTYPE_ROUTE : MAPSECTYPE_NONE;
    case MAPSEC_FALLARBOR_WASTELAND:
