...
static const u8 sText_PkmnSoulSiphon[] = _("{B_ATK_NAME_WITH_PREFIX} stole HP\nfrom {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnsAbilitySuppressed[] = _("{B_DEF_NAME_WITH_PREFIX}'s abilities\nwere suppressed!");
...
static const u8 sText_QuashSuccess[] = _("The opposing {B_DEF_NAME_WITH_PREFIX}'s move\nwas postponed!");
...
static const u8 sText_MegaEvoEvolved[] = _("{B_ATK_NAME_WITH_PREFIX} has Mega Evolved \ninto Mega {B_BUFF1}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNSOULSIPHON - 12] = sText_PkmnSoulSiphon,
...
static const u8 sRecordedBattleTextSpeeds[] = {8, 4, 1, TEXT_SPEED_VFAST};
