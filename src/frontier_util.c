    ...
    [FRONTIER_FACILITY_PYRAMID] =
    {
        ...
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_BOLD,
                .evs = {6, 0, 0, 252, 252, 0},
                .moves = {MOVE_THUNDER, MOVE_HEAT_WAVE, MOVE_ROOST, MOVE_LIGHT_SCREEN},
            },
            {
