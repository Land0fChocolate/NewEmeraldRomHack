...
struct InGameTrade {
    ...
    /*0x14*/ u8 abilityNum; //TODO: unused
    /*0x18*/ u32 otId;
...
static void LoadTradeMonPic(u8 whichParty, u8 state)
{
    ...
    case 0:
        ...
        HandleLoadSpecialPokePic(TRUE, gMonSpritesGfxPtr->sprites.ptr[whichParty * 2 + 1], species, personality);
...
static bool8 AnimateTradeSequenceCable(void)
{
    ...
    case TS_STATE_POKEBALL_ARRIVE_WAIT:
        ...
        {
            HandleLoadSpecialPokePic(TRUE, gMonSpritesGfxPtr->sprites.ptr[3], sTradeData->monSpecies[TRADE_PARTNER], sTradeData->monPersonalities[TRADE_PARTNER]);
            sTradeData->state++;
        }
        break;
