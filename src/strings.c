...
const u8 gText_SerpentDance48BP[] = _("SERPENT DANCE{CLEAR_TO 0x4E}48BP");
const u8 gText_FlintBlade48BP[] = _("FLINT BLADE{CLEAR_TO 0x4E}48BP");
const u8 gText_FlareCrash48BP[] = _("FLARE CRASH{CLEAR_TO 0x4E}48BP");
