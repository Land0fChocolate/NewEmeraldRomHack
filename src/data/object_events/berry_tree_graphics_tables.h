...
const u16 *const gBerryTreePaletteTagTablePointers[] = {
    ...
    [ITEM_OCCA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    ...
    [ITEM_YACHE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Chesto,
    [ITEM_CHOPLE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Pomeg,
    [ITEM_KEBIA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Rabuta,
    [ITEM_SHUCA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Iapapa,
    [ITEM_COBA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Rawst,
    [ITEM_PAYAPA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_TANGA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Rabuta,
    [ITEM_CHARTI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Iapapa,
    [ITEM_KASIB_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_HABAN_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Tamato,
    [ITEM_COLBUR_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Persim,
    [ITEM_BABIRI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Liechi,
    [ITEM_ROSELI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    ...
    [ITEM_MICLE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_CUSTAP_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_JABOCA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_ROWAP_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_KEE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Pecha,
    [ITEM_MARANGA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
};
