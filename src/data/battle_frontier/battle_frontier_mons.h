const struct FacilityMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    [FRONTIER_MON_FEEBAS] = {
        ...
        .moves = {MOVE_FLAIL, MOVE_MIRROR_COAT, MOVE_DRAGON_BREATH, MOVE_SWIFT},
    ...
    [FRONTIER_MON_MANTYKE] = {
        ...
        .moves = {MOVE_BUBBLE_BEAM, MOVE_ICY_WIND, MOVE_ATTRACT, MOVE_AQUA_RING},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_SERIOUS
    },
    ...
    [FRONTIER_MON_MAKUHITA] = {
        ...
        .moves = {MOVE_FAKE_OUT, MOVE_SEISMIC_TOSS, MOVE_KNOCK_OFF, MOVE_WHIRLWIND},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_NINCADA] = {
        ...
        .moves = {MOVE_MUD_SLAP, MOVE_DIG, MOVE_TOXIC, MOVE_METAL_CLAW},
    ...
    [FRONTIER_MON_CARVANHA] = {
        ...
        .moves = {MOVE_BITE, MOVE_SCREECH, MOVE_AQUA_JET, MOVE_SWAGGER},
    ...
    [FRONTIER_MON_GASTLY] = {
        ...
        .moves = {MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_SUCKER_PUNCH, MOVE_CONFUSE_RAY},
        .item = ITEM_LAX_INCENSE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    [FRONTIER_MON_SWABLU] = {
        ...
        .moves = {MOVE_ECHOED_VOICE, MOVE_DREAM_EATER, MOVE_SING, MOVE_ATTRACT},
        .item = ITEM_METRONOME,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    ...
    [FRONTIER_MON_TORCHIC] = {
        ...
        .moves = {MOVE_FLAME_BURST, MOVE_QUICK_ATTACK, MOVE_SWORDS_DANCE, MOVE_BATON_PASS},
    ...
    [FRONTIER_MON_CHIKORITA] = {
        ...
        .moves = {MOVE_SECRET_POWER, MOVE_BULLET_SEED, MOVE_NATURE_POWER, MOVE_LIGHT_SCREEN},
        .item = ITEM_NORMAL_GEM,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    ...
    [FRONTIER_MON_GOLDEEN] = {
        ...
        .moves = {MOVE_WATERFALL, MOVE_FURY_ATTACK, MOVE_AQUA_RING, MOVE_PSYBEAM},
        .item = ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_NATU] = {
        ...
        .moves = {MOVE_NIGHT_SHADE, MOVE_FUTURE_SIGHT, MOVE_CONFUSE_RAY, MOVE_TRICK_ROOM},
        .item = ITEM_TWISTED_SPOON,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_CLEFAIRY] = {
        ...
        .moves = {MOVE_FOLLOW_ME, MOVE_DRAINING_KISS, MOVE_ENCORE, MOVE_SING},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    ...
    [FRONTIER_MON_SEEL] = {
        ...
        .moves = {MOVE_AURORA_BEAM, MOVE_DIVE, MOVE_SMART_STRIKE, MOVE_FAKE_OUT},
    ...
    [FRONTIER_MON_GRIMER] = {
        ...
        .moves = {MOVE_SLUDGE, MOVE_ROCK_TOMB, MOVE_ACID_ARMOR, MOVE_BELCH},
    ...
    [FRONTIER_MON_KRABBY] = {
        ...
        .moves = {MOVE_CRABHAMMER, MOVE_MUD_SHOT, MOVE_ROCK_SMASH, MOVE_KNOCK_OFF},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_EEVEE] = {
        ...
        .moves = {MOVE_BABY_DOLL_EYES, MOVE_ATTRACT, MOVE_FLAIL, MOVE_ENDURE},
        .item = ITEM_SALAC_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_DROWZEE] = {
        ...
        .moves = {MOVE_CONFUSION, MOVE_HEADBUTT, MOVE_TRICK_ROOM, MOVE_BARRIER},
        .item = ITEM_SITRUS_BERRY,
    ...
    [FRONTIER_MON_VOLTORB] = {
        ...
        .moves = {MOVE_SPARK, MOVE_EERIE_IMPULSE, MOVE_ROLLOUT, MOVE_CHARGE},
        .item = ITEM_MAGNET,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_TEDDIURSA] = {
        ...
        .moves = {MOVE_SECRET_POWER, MOVE_PLAY_NICE, MOVE_PAYBACK, MOVE_REST},
        .item = ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    ...
    [FRONTIER_MON_HOUNDOUR] = {
        ...
        .moves = {MOVE_CRUNCH, MOVE_FIRE_FANG, MOVE_ROAR, MOVE_SNARL},
        .item = ITEM_CHARCOAL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_PHANPY] = {
        ...
        .moves = {MOVE_ROLLOUT, MOVE_DEFENSE_CURL, MOVE_BULLDOZE, MOVE_SANDSTORM},
        .item = ITEM_SMOOTH_ROCK,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAUGHTY
    },
    ...
    [FRONTIER_MON_ARON] = {
        ...
        .moves = {MOVE_METAL_CLAW, MOVE_STEALTH_ROCK, MOVE_AUTOTOMIZE, MOVE_ROAR},
        .item = ITEM_HEAVY_DUTY_BOOTS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_TENTACOOL] = {
        ...
        .moves = {MOVE_BUBBLE_BEAM, MOVE_TOXIC_SPIKES, MOVE_BARRIER, MOVE_WRAP},
        .item = ITEM_BINDING_BAND,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_CACNEA] = {
        ...
        .moves = {MOVE_NEEDLE_ARM, MOVE_FEINT_ATTACK, MOVE_COTTON_SPORE, MOVE_HIDDEN_THORNS},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_KOFFING] = {
        ...
        .moves = {MOVE_SLUDGE, MOVE_SMOKESCREEN, MOVE_TORMENT, MOVE_CLEAR_SMOG},
        .item = ITEM_POISON_BARB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_STARYU] = {
        ...
        .moves = {MOVE_BUBBLE_BEAM, MOVE_POWER_GEM, MOVE_SIGNAL_BEAM, MOVE_LIGHT_SCREEN},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_SKIPLOOM] = {
        ...
        .moves = {MOVE_MEGA_DRAIN, MOVE_ACROBATICS, MOVE_COTTON_SPORE, MOVE_SLEEP_POWDER},
    ...
    [FRONTIER_MON_VIBRAVA] = {
        ...
        .moves = {MOVE_DRAGON_BREATH, MOVE_DIG, MOVE_SCREECH, MOVE_U_TURN},
        .item = ITEM_LIFE_ORB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_CLAMPERL] = {
        ...
        .moves = {MOVE_SCALD, MOVE_TOXIC, MOVE_SHELL_SMASH, MOVE_ICY_WIND},
    ...
    [FRONTIER_MON_PIDGEOTTO] = {
        ...
        .moves = {MOVE_AIR_SLASH, MOVE_STEEL_WING, MOVE_FEATHER_DANCE, MOVE_TAILWIND},
        .item = ITEM_WHITE_HERB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_FARFETCHD] = {
        ...
        .moves = {MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_AIR_CUTTER, MOVE_AGILITY},
        .item = ITEM_LEEK,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_OMANYTE] = {
        ...
        .moves = {MOVE_MUD_SHOT, MOVE_WATER_PULSE, MOVE_ANCIENT_POWER, MOVE_TICKLE},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_KABUTO] = {
        ...
        .moves = {MOVE_MEGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_BUBBLE_BEAM, MOVE_PROTECT},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_ANORITH] = {
        ...
        .moves = {MOVE_METAL_CLAW, MOVE_FURY_CUTTER, MOVE_ANCIENT_POWER, MOVE_AQUA_JET},
        .item = ITEM_ASSAULT_VEST,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_ELEKID] = {
        ...
        .moves = {MOVE_THUNDER_PUNCH, MOVE_QUICK_ATTACK, MOVE_ROCK_SMASH, MOVE_LIGHT_SCREEN},
        .item = ITEM_RAWST_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAIVE
    },
    [FRONTIER_MON_LOUDRED] = {
        ...
        .moves = {MOVE_ECHOED_VOICE, MOVE_ROCK_TOMB, MOVE_ASTONISH, MOVE_SUPERSONIC},
        .item = ITEM_METRONOME,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    ...
    [FRONTIER_MON_NIDORINA] = {
        ...
        .moves = {MOVE_DOUBLE_KICK, MOVE_BITE, MOVE_TOXIC_SPIKES, MOVE_FLATTER},
        .item = ITEM_AIR_BALLOON,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_NIDORINO] = {
        ...
        .moves = {MOVE_DOUBLE_KICK, MOVE_WATER_PULSE, MOVE_SHADOW_CLAW, MOVE_FLATTER},
        .item = ITEM_EXPERT_BELT,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_FLAAFFY] = {
        ...
        .moves = {MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_COTTON_GUARD, MOVE_LIGHT_SCREEN},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MILD
    },
    [FRONTIER_MON_MAGBY] = {
        ...
        .moves = {MOVE_FIRE_PUNCH, MOVE_CLEAR_SMOG, MOVE_WILL_O_WISP, MOVE_LOW_KICK},
    ...
    [FRONTIER_MON_NOSEPASS] = {
        ...
        .moves = {MOVE_ROCK_SLIDE, MOVE_DISCHARGE, MOVE_THUNDER_WAVE, MOVE_SANDSTORM},
        .item = ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [FRONTIER_MON_CORSOLA] = {
        ...
        .moves = {MOVE_BUBBLE_BEAM, MOVE_MIRROR_COAT, MOVE_AQUA_RING, MOVE_SPIKE_CANNON},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
    ...
    [FRONTIER_MON_MAWILE] = {
        ...
        .moves = {MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH, MOVE_IRON_DEFENSE, MOVE_PAIN_SPLIT},
    ...
    [FRONTIER_MON_BUTTERFREE] = {
        ...
        .moves = {MOVE_SILVER_WIND, MOVE_PSYBEAM, MOVE_AIR_SLASH, MOVE_QUIVER_DANCE},
        .item = ITEM_PECHA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_BEEDRILL] = {
        ...
        .moves = {MOVE_FELL_STINGER, MOVE_BRICK_BREAK, MOVE_POISON_JAB, MOVE_SWORDS_DANCE},
        .item = ITEM_BUG_GEM,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [FRONTIER_MON_POLIWHIRL] = {
        ...
        .moves = {MOVE_WATER_PULSE, MOVE_HYPNOSIS, MOVE_ICY_WIND, MOVE_RAIN_DANCE},
        .item = ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_BEAUTIFLY] = {
        ...
        .moves = {MOVE_BUG_BUZZ, MOVE_GIGA_DRAIN, MOVE_AIR_CUTTER, MOVE_ELECTROWEB},
        .item = ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_DUSTOX] = {
        ...
        .moves = {MOVE_SILVER_WIND, MOVE_VENOSHOCK, MOVE_PSYBEAM, MOVE_QUIVER_DANCE},
        .item = ITEM_RAWST_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_LEDIAN] = {
        ...
        .moves = {MOVE_DYNAMIC_PUNCH, MOVE_BATON_PASS, MOVE_SWORDS_DANCE, MOVE_AGILITY},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_BASHFUL
    },
    [FRONTIER_MON_ARIADOS] = {
        ...
        .moves = {MOVE_BUG_BITE, MOVE_TOXIC_THREAD, MOVE_NIGHT_SHADE, MOVE_VENOSHOCK},
        .item = ITEM_BLACK_SLUDGE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_SERIOUS
    },
    [FRONTIER_MON_YANMA] = {
        ...
        .moves = {MOVE_SIGNAL_BEAM, MOVE_ANCIENT_POWER, MOVE_ROOST, MOVE_U_TURN},
    ...
    [FRONTIER_MON_DELCATTY_1] = {
        ...
        .moves = {MOVE_BODY_SLAM, MOVE_ATTRACT, MOVE_COPYCAT, MOVE_HEAL_BELL},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    ...
    [FRONTIER_MON_RHYDON_1] = {
        ...
        .moves = {MOVE_BULLDOZE, MOVE_ROCK_SLIDE, MOVE_SMART_STRIKE, MOVE_ROCK_SMASH},
        .item = ITEM_RINDO_BERRY,
    ...
    [FRONTIER_MON_ELECTABUZZ_1] = {
        ...
        .moves = {MOVE_DISCHARGE, MOVE_SIGNAL_BEAM, MOVE_ELECTROWEB, MOVE_LIGHT_SCREEN},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_TIMID
    },
    [FRONTIER_MON_MAGMAR_1] = {
        ...
        .moves = {MOVE_LAVA_PLUME, MOVE_PSYCHIC, MOVE_BELCH, MOVE_ATTRACT},
        .item = ITEM_SITRUS_BERRY,
    ...
    [FRONTIER_MON_AMBIPOM_1] = {
        ...
        .moves = {MOVE_FAKE_OUT, MOVE_SHADOW_CLAW, MOVE_FLING, MOVE_SWITCHEROO},
        .item = ITEM_KINGS_ROCK,
    ...
    [FRONTIER_MON_LICKITUNG_1] = {
        ...
        .moves = {MOVE_CHIP_AWAY, MOVE_ROCK_SMASH, MOVE_LICK, MOVE_ME_FIRST},
    ...
    [FRONTIER_MON_WEEPINBELL_1] = {
        ...
        .moves = {MOVE_RAZOR_LEAF, MOVE_POISON_JAB, MOVE_WRAP, MOVE_GASTRO_ACID},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FRONTIER_MON_GRAVELER_1] = {
        ...
        .moves = {MOVE_MAGNITUDE, MOVE_ROCK_BLAST, MOVE_ROCK_POLISH, MOVE_NATURE_POWER},
        .item = ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_GLOOM_1] = {
        ...
        .moves = {MOVE_PETAL_DANCE, MOVE_VENOSHOCK, MOVE_STUN_SPORE, MOVE_MOONLIGHT},
        .item = ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_KADABRA_1] = {
        ...
        .moves = {MOVE_CONFUSION, MOVE_ROLE_PLAY, MOVE_FUTURE_SIGHT, MOVE_CHARGE_BEAM},
        .item = ITEM_TWISTED_SPOON,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    [FRONTIER_MON_WAILMER_1] = {
        ...
        .moves = {MOVE_WHIRLPOOL, MOVE_ICY_WIND, MOVE_AMNESIA, MOVE_ROLLOUT},
        .item = ITEM_BINDING_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_ROSELIA_1] = {
        ...
        .moves = {MOVE_MAGICAL_LEAF, MOVE_TOXIC_SPIKES, MOVE_GRASS_WHISTLE, MOVE_DRAINING_KISS},
        .item = ITEM_CHERI_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_VOLBEAT_1] = {
        ...
        .moves = {MOVE_INFESTATION, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE, MOVE_MOONLIGHT},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_ILLUMISE_1] = {
        ...
        .moves = {MOVE_STRUGGLE_BUG, MOVE_WISH, MOVE_COVET, MOVE_TAILWIND},
        .item = ITEM_NORMAL_GEM,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_IVYSAUR_1] = {
        ...
        .moves = {MOVE_GRASS_KNOT, MOVE_SLEEP_POWDER, MOVE_WORRY_SEED, MOVE_SLUDGE_BOMB},
        .item = ITEM_GRASS_GEM,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_GENTLE
    },
    ...
    [FRONTIER_MON_PARASECT_1] = {
        ...
        .moves = {MOVE_SLASH, MOVE_PSYBEAM, MOVE_SPORE, MOVE_LEECH_LIFE},
    ...
    [FRONTIER_MON_MACHOKE_1] = {
        ...
        .moves = {MOVE_REVENGE, MOVE_DUAL_CHOP, MOVE_PAYBACK, MOVE_SCARY_FACE},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_HAUNTER_1] = {
        ...
        .moves = {MOVE_HEX, MOVE_CONFUSE_RAY, MOVE_WILL_O_WISP, MOVE_GRUDGE},
        .item = ITEM_BLACK_SLUDGE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_RASH
    },
    [FRONTIER_MON_BAYLEEF_1] = {
        ...
        .moves = {MOVE_RAZOR_LEAF, MOVE_TOXIC, MOVE_REFLECT, MOVE_LIGHT_SCREEN},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_QUILAVA_1] = {
        ...
        .moves = {MOVE_FLAME_CHARGE, MOVE_EXTRASENSORY, MOVE_SWIFT, MOVE_SMOKESCREEN},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_CROCONAW_1] = {
        ...
        .moves = {MOVE_ICE_FANG, MOVE_WATER_PULSE, MOVE_BITE, MOVE_SCARY_FACE},
        .item = ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_TOGETIC_1] = {
        ...
        .moves = {MOVE_DRAINING_KISS, MOVE_MAGICAL_LEAF, MOVE_WISH, MOVE_FOLLOW_ME},
        .item = ITEM_BIG_ROOT,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_MURKROW_1] = {
        ...
        .moves = {MOVE_SUCKER_PUNCH, MOVE_FLY, MOVE_TORMENT, MOVE_DEFOG},
        .item = ITEM_EVIOLITE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_PLUSLE_1] = {
        ...
        .moves = {MOVE_DISCHARGE, MOVE_NASTY_PLOT, MOVE_BATON_PASS, MOVE_HELPING_HAND},
        .item = ITEM_SALAC_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_MINUN_1] = {
        ...
        .moves = {MOVE_SPARK, MOVE_SWITCHEROO, MOVE_ENCORE, MOVE_HELPING_HAND},
        .item = ITEM_CHOICE_SCARF,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_GROVYLE_1] = {
        ...
        .moves = {MOVE_X_SCISSOR, MOVE_DRAIN_PUNCH, MOVE_QUICK_ATTACK, MOVE_SEED_BOMB},
        .item = ITEM_MUSCLE_BAND,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_COMBUSKEN_1] = {
        ...
        .moves = {MOVE_SLASH, MOVE_BRICK_BREAK, MOVE_FLAME_CHARGE, MOVE_SHADOW_CLAW},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_MARSHTOMP_1] = {
        ...
        .moves = {MOVE_MUD_SHOT, MOVE_WATER_PULSE, MOVE_ROCK_TOMB, MOVE_ICE_PUNCH},
        .item = ITEM_RINDO_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_PONYTA_1] = {
        ...
        .moves = {MOVE_FLAME_CHARGE, MOVE_BOUNCE, MOVE_QUICK_ATTACK, MOVE_TAIL_WHIP},
        .item = ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_MAGCARGO_1] = {
        ...
        .moves = {MOVE_ROCK_SLIDE, MOVE_FLAME_BURST, MOVE_ACID_ARMOR, MOVE_INFESTATION},
        .item = ITEM_PASSHO_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_GENTLE
    },
    [FRONTIER_MON_PUPITAR_1] = {
        ...
        .moves = {MOVE_DIG, MOVE_PAYBACK, MOVE_SCARY_FACE, MOVE_SANDSTORM},
        .item = ITEM_SMOOTH_ROCK,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_MASQUERAIN_1] = {
        ...
        .moves = {MOVE_SILVER_WIND, MOVE_OMINOUS_WIND, MOVE_ICY_WIND, MOVE_STUN_SPORE},
    ...
    [FRONTIER_MON_DRAGONAIR_1] = {
        ...
        .moves = {MOVE_DRAGON_BREATH, MOVE_DRAGON_TAIL, MOVE_WRAP, MOVE_SAFEGUARD},
    ...
    [FRONTIER_MON_MIGHTYENA_1] = {
        ...
        .moves = {MOVE_SNARL, MOVE_POISON_FANG, MOVE_TAUNT, MOVE_YAWN},
        .item = ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_TIMID
    },
    [FRONTIER_MON_LINOONE_1] = {
        ...
        .moves = {MOVE_SECRET_POWER, MOVE_SHADOW_CLAW, MOVE_SUBSTITUTE, MOVE_SWAGGER},
        .item = ITEM_PECHA_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_CASTFORM_1] = {
        ...
        .moves = {MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_SHOCK_WAVE},
        .item = ITEM_HEAT_ROCK,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HASTY
    },
    ...
    [FRONTIER_MON_METANG_1] = {
        ...
        .moves = {MOVE_BULLET_PUNCH, MOVE_CONFUSION, MOVE_PURSUIT, MOVE_MAGNET_RISE},
    ...
    [FRONTIER_MON_WIGGLYTUFF_1] = {
        ...
        .moves = {MOVE_SING, MOVE_DISABLE, MOVE_WISH, MOVE_DRAINING_KISS},
        .item = ITEM_FAIRY_GEM,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_SUNFLORA_1] = {
        ...
        .moves = {MOVE_MEGA_DRAIN, MOVE_INGRAIN, MOVE_LEECH_SEED, MOVE_FLOWER_SHIELD},
        .item = ITEM_BIG_ROOT,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_CHIMECHO_1] = {
        ...
        .moves = {MOVE_PSYWAVE, MOVE_TAKE_DOWN, MOVE_HEAL_BELL, MOVE_TRICK_ROOM},
        .item = ITEM_TWISTED_SPOON,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [FRONTIER_MON_GLIGAR_1] = {
        ...
        .moves = {MOVE_METAL_CLAW, MOVE_DIG, MOVE_ACROBATICS, MOVE_U_TURN},
    ...
    [FRONTIER_MON_QWILFISH_1] = {
        ...
        .moves = {MOVE_BUBBLE_BEAM, MOVE_PIN_MISSILE, MOVE_SPIKES, MOVE_TOXIC_SPIKES},
        .item = ITEM_AIR_BALLOON,
    ...
    [FRONTIER_MON_SNEASEL_1] = {
        ...
        .moves = {MOVE_THROAT_CHOP, MOVE_FAKE_OUT, MOVE_LOW_SWEEP, MOVE_ICE_SHARD},
    ...
    [FRONTIER_MON_PELIPPER_1] = {
        ...
        .moves = {MOVE_WATER_PULSE, MOVE_SPIT_UP, MOVE_STOCKPILE, MOVE_SWALLOW},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FRONTIER_MON_SWELLOW_1] = {
        ...
        .moves = {MOVE_FLY, MOVE_ENDEAVOR, MOVE_U_TURN, MOVE_QUICK_ATTACK},
        .item = ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_TANGELA_1] = {
        ...
        .moves = {MOVE_MEGA_DRAIN, MOVE_INFESTATION, MOVE_GRASSY_TERRAIN, MOVE_BIND},
    ...
    [FRONTIER_MON_ARBOK_1] = {
        ...
        .moves = {MOVE_POISON_FANG, MOVE_DIG, MOVE_BITE, MOVE_COIL},
        .item = ITEM_POISON_BARB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_PERSIAN_1] = {
        ...
        .moves = {MOVE_FAKE_OUT, MOVE_SLASH, MOVE_TORMENT, MOVE_NIGHT_SLASH},
        .item = ITEM_SILK_SCARF,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_SEADRA_1] = {
        ...
        .moves = {MOVE_AURORA_BEAM, MOVE_SIGNAL_BEAM, MOVE_BRINE, MOVE_RAIN_DANCE},
        .item = ITEM_MYSTIC_WATER,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    ...
    [FRONTIER_MON_VIGOROTH_1] = {
        ...
        .moves = {MOVE_CHIP_AWAY, MOVE_COUNTER, MOVE_ENCORE, MOVE_LOW_SWEEP},
        .item = ITEM_LIFE_ORB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    ...
    [FRONTIER_MON_NOCTOWL_1] = {
        ...
        .moves = {MOVE_ZEN_HEADBUTT, MOVE_AERIAL_ACE, MOVE_FEINT_ATTACK, MOVE_REFLECT},
        .item = ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_SANDSLASH_1] = {
        ...
        .moves = {MOVE_CRUSH_CLAW, MOVE_ROCK_SLIDE, MOVE_SAND_TOMB, MOVE_SANDSTORM},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_SEAKING_1] = {
        ...
        .moves = {MOVE_WATER_PULSE, MOVE_PSYBEAM, MOVE_SMART_STRIKE, MOVE_AGILITY},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_PILOSWINE_1] = {
        ...
        .moves = {MOVE_DIG, MOVE_ANCIENT_POWER, MOVE_ICE_FANG, MOVE_LIGHT_SCREEN},
        .item = ITEM_SOFT_SAND,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_GOLBAT_1] = {
        ...
        .moves = {MOVE_WING_ATTACK, MOVE_CONFUSE_RAY, MOVE_POISON_FANG, MOVE_STEEL_WING},
        .item = ITEM_EVIOLITE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_PRIMEAPE_1] = {
        ...
        .moves = {MOVE_KARATE_CHOP, MOVE_PUNISHMENT, MOVE_SWAGGER, MOVE_SCREECH},
        .item = ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_HITMONLEE_1] = {
        ...
        .moves = {MOVE_ROLLING_KICK, MOVE_BLAZE_KICK, MOVE_FOCUS_ENERGY, MOVE_THROAT_CHOP},
        .item = ITEM_BLACK_BELT,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_HITMONCHAN_1] = {
        ...
        .moves = {MOVE_MACH_PUNCH, MOVE_BULLET_PUNCH, MOVE_VACUUM_WAVE, MOVE_WORK_UP},
        .item = ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_GIRAFARIG_1] = {
        ...
        .moves = {MOVE_PSYBEAM, MOVE_CHARGE_BEAM, MOVE_WISH, MOVE_SKILL_SWAP},
        .item = ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FRONTIER_MON_HITMONTOP_1] = {
        ...
        .moves = {MOVE_TRIPLE_KICK, MOVE_DIG, MOVE_MACH_PUNCH, MOVE_BODY_SLAM},
        .item = ITEM_LIECHI_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_BANETTE_1] = {
        ...
        .moves = {MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_TRICK, MOVE_CHARGE_BEAM},
    ...
    [FRONTIER_MON_SEVIPER_1] = {
        ...
        .moves = {MOVE_POISON_FANG, MOVE_BITE, MOVE_PSYCHIC_FANGS, MOVE_SCREECH},
        .item = ITEM_BLACK_SLUDGE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_ZANGOOSE_1] = {
        ...
        .moves = {MOVE_SLASH, MOVE_SHADOW_CLAW, MOVE_TAUNT, MOVE_ROCK_SMASH},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_CAMERUPT_1] = {
        ...
        .moves = {MOVE_MAGNITUDE, MOVE_FLAME_BURST, MOVE_YAWN, MOVE_ROCK_TOMB},
        .item = ITEM_ROCKY_HELMET,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_SHARPEDO_1] = {
        ...
        .moves = {MOVE_ICE_FANG, MOVE_BITE, MOVE_AQUA_JET, MOVE_SCARY_FACE},
        .item = ITEM_LIFE_ORB,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_TROPIUS_1] = {
        ...
        .moves = {MOVE_LEAF_TORNADO, MOVE_TAILWIND, MOVE_AIR_SLASH, MOVE_ROOST},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_MAGNETON_1] = {
        ...
        .moves = {MOVE_ELECTRO_BALL, MOVE_MIRROR_SHOT, MOVE_THUNDER_WAVE, MOVE_SUPERSONIC},
        .item = ITEM_SHUCA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_LONELY
    },
    [FRONTIER_MON_MANTINE_1] = {
        ...
        .moves = {MOVE_BUBBLE_BEAM, MOVE_WING_ATTACK, MOVE_RAIN_DANCE, MOVE_CONFUSE_RAY},
        .item = ITEM_MYSTIC_WATER,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_STANTLER_1] = {
        ...
        .moves = {MOVE_EXTRASENSORY, MOVE_CONFUSE_RAY, MOVE_STOMP, MOVE_ROLE_PLAY},
        .item = ITEM_TWISTED_SPOON,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_GENTLE
    },
    ...
    [FRONTIER_MON_CRAWDAUNT_1] = {
        ...
        .moves = {MOVE_BUBBLE_BEAM, MOVE_VISE_GRIP, MOVE_KNOCK_OFF, MOVE_TAUNT},
        .item = ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_PIDGEOT_1] = {
        ...
        .moves = {MOVE_WING_ATTACK, MOVE_MIRROR_MOVE, MOVE_TAILWIND, MOVE_FEINT_ATTACK},
        .item = ITEM_SHARP_BEAK,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_GRUMPIG_1] = {
        ...
        .moves = {MOVE_PSYBEAM, MOVE_TEETER_DANCE, MOVE_FUTURE_SIGHT, MOVE_MAGIC_COAT},
        .item = ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_TORKOAL_1] = {
        ...
        .moves = {MOVE_FLAME_WHEEL, MOVE_FIRE_SPIN, MOVE_GYRO_BALL, MOVE_AMNESIA},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_KINGLER_1] = {
        ...
        .moves = {MOVE_CRABHAMMER, MOVE_METAL_CLAW, MOVE_MUD_SHOT, MOVE_TICKLE},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_CACTURNE_1] = {
        ...
        .moves = {MOVE_NEEDLE_ARM, MOVE_FEINT_ATTACK, MOVE_POISON_JAB, MOVE_HIDDEN_THORNS},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_HASTY
    },
    [FRONTIER_MON_BELLOSSOM_1] = {
        ...
        .moves = {MOVE_PETAL_DANCE, MOVE_DAZZLING_GLEAM, MOVE_HIDDEN_THORNS, MOVE_SYNTHESIS},
        .item = ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    ...
    [FRONTIER_MON_HUNTAIL_1] = {
        ...
        .moves = {MOVE_DIVE, MOVE_SCARY_FACE, MOVE_INFESTATION, MOVE_BITE},
        .item = ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FRONTIER_MON_GOREBYSS_1] = {
        ...
        .moves = {MOVE_WHIRLPOOL, MOVE_AMNESIA, MOVE_ICY_WIND, MOVE_AQUA_RING},
        .item = ITEM_BINDING_BAND,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BRAVE
    },
    [FRONTIER_MON_RELICANTH_1] = {
        ...
        .moves = {MOVE_ANCIENT_POWER, MOVE_WATER_PULSE, MOVE_YAWN, MOVE_AMNESIA},
        .item = ITEM_GANLON_BERRY,
    ...
    [FRONTIER_MON_KABUTOPS_1] = {
        ...
        .moves = {MOVE_AQUA_JET, MOVE_DIG, MOVE_FURY_CUTTER, MOVE_ROCK_POLISH},
        .item = ITEM_APICOT_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_POLIWRATH_1] = {
        ...
        .moves = {MOVE_SUBMISSION, MOVE_THROAT_CHOP, MOVE_ROCK_TOMB, MOVE_BUBBLE_BEAM},
        .item = ITEM_BLACK_BELT,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_SCYTHER_1] = {
        ...
        .moves = {MOVE_U_TURN, MOVE_WING_ATTACK, MOVE_SAFEGUARD, MOVE_FEINT},
    ...
    [FRONTIER_MON_PINSIR_1] = {
        ...
        .moves = {MOVE_SUBMISSION, MOVE_KNOCK_OFF, MOVE_SWORDS_DANCE, MOVE_DOUBLE_HIT},
        .item = ITEM_BLACK_BELT,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAUGHTY
    },
    [FRONTIER_MON_POLITOED_1] = {
        ...
        .moves = {MOVE_DIVE, MOVE_DIG, MOVE_BOUNCE, MOVE_SWAGGER},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_CLOYSTER_1] = {
        ...
        .moves = {MOVE_ICICLE_SPEAR, MOVE_SPIKE_CANNON, MOVE_SPIKES, MOVE_CLAMP},
        .item = ITEM_PECHA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [FRONTIER_MON_DELCATTY_2] = {
        .species = SPECIES_DELCATTY,
        .moves = {MOVE_CHARM, MOVE_ASSIST, MOVE_PLAY_ROUGH, MOVE_FAKE_OUT},
        .item = ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_SPEED,
    ...
    [FRONTIER_MON_DUSCLOPS_2] = {
        .species = SPECIES_DUSCLOPS,
        .moves = {MOVE_TOXIC, MOVE_CURSE, MOVE_TRICK, MOVE_PAIN_SPLIT},
        .item = ITEM_CHOICE_SPECS,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    [FRONTIER_MON_RHYDON_2] = {
        .species = SPECIES_RHYDON,
        .moves = {MOVE_DRILL_RUN, MOVE_SMACK_DOWN, MOVE_DRAGON_TAIL, MOVE_COUNTER},
        .item = ITEM_ROCKY_HELMET,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_ELECTABUZZ_2] = {
        .species = SPECIES_ELECTABUZZ,
        .moves = {MOVE_THUNDER_PUNCH, MOVE_LOW_KICK, MOVE_REFLECT, MOVE_VOLT_SWITCH},
        .item = ITEM_SAFETY_GOGGLES,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_JOLLY
    },
    [FRONTIER_MON_MAGMAR_2] = {
        .species = SPECIES_MAGMAR,
        .moves = {MOVE_FIRE_PUNCH, MOVE_CROSS_CHOP, MOVE_IRON_TAIL, MOVE_CONFUSE_RAY},
        .item = ITEM_LIFE_ORB,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_SP_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_MISDREAVUS_2] = {
        .species = SPECIES_MISDREAVUS,
        .moves = {MOVE_SHADOW_BALL, MOVE_POWER_GEM, MOVE_DAZZLING_GLEAM, MOVE_WILL_O_WISP},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_TIMID
    },
    ...
    [FRONTIER_MON_LICKITUNG_2] = {
        .species = SPECIES_LICKITUNG,
        .moves = {MOVE_AQUA_TAIL, MOVE_WRING_OUT, MOVE_BODY_SLAM, MOVE_ME_FIRST},
        .item = ITEM_CHERI_BERRY,
    ...
    [FRONTIER_MON_GRAVELER_2] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_STEALTH_ROCK, MOVE_COUNTER},
        .item = ITEM_EVIOLITE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_VOLBEAT_2] = {
        .species = SPECIES_VOLBEAT,
        .moves = {MOVE_BUG_BUZZ, MOVE_THUNDERBOLT, MOVE_DAZZLING_GLEAM, MOVE_TAIL_GLOW},
        .item = ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_ILLUMISE_2] = {
        .species = SPECIES_ILLUMISE,
        .moves = {MOVE_BUG_BUZZ, MOVE_CHARGE_BEAM, MOVE_ENCORE, MOVE_GIGA_DRAIN},
        .item = ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_CHARMELEON_2] = {
        .species = SPECIES_CHARMELEON,
        .moves = {MOVE_HEAT_WAVE, MOVE_DRAGON_PULSE, MOVE_ANCIENT_POWER, MOVE_SUNNY_DAY},
        .item = ITEM_WISE_GLASSES,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_SP_ATTACK,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_WARTORTLE_2] = {
        .species = SPECIES_WARTORTLE,
        .moves = {MOVE_SCALD, MOVE_ICE_BEAM, MOVE_RAPID_SPIN, MOVE_MIRROR_COAT},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_PARASECT_2] = {
        .species = SPECIES_PARASECT,
        .moves = {MOVE_SPORE, MOVE_GIGA_DRAIN, MOVE_CROSS_POISON, MOVE_X_SCISSOR},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CALM
    },
    [FRONTIER_MON_MACHOKE_2] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_SLIDE, MOVE_DUAL_CHOP, MOVE_SCARY_FACE},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_HAUNTER_2] = {
        .species = SPECIES_HAUNTER,
        .moves = {MOVE_SHADOW_BALL, MOVE_HYPNOSIS, MOVE_NIGHTMARE, MOVE_CONFUSE_RAY},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    ...
    [FRONTIER_MON_QUILAVA_2] = {
        .species = SPECIES_QUILAVA,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_IRON_TAIL, MOVE_BODY_SLAM, MOVE_WILD_CHARGE},
        .item = ITEM_MUSCLE_BAND,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_CROCONAW_2] = {
        .species = SPECIES_CROCONAW,
        .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_ANCIENT_POWER, MOVE_SCARY_FACE},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_TOGETIC_2] = {
        .species = SPECIES_TOGETIC,
        .moves = {MOVE_DAZZLING_GLEAM, MOVE_MAGICAL_LEAF, MOVE_WISH, MOVE_YAWN},
        .item = ITEM_WEAKNESS_POLICY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_MURKROW_2] = {
        .species = SPECIES_MURKROW,
        .moves = {MOVE_PERISH_SONG, MOVE_MEAN_LOOK, MOVE_ROOST, MOVE_THUNDER_WAVE},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_MINUN_2] = {
        .species = SPECIES_MINUN,
        .moves = {MOVE_DISCHARGE, MOVE_ATTRACT, MOVE_FAKE_TEARS, MOVE_WISH},
        .item = ITEM_APICOT_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_GROVYLE_2] = {
        .species = SPECIES_GROVYLE,
        .moves = {MOVE_GIGA_DRAIN, MOVE_SWAGGER, MOVE_SUBSTITUTE, MOVE_HIDDEN_THORNS},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_MARSHTOMP_2] = {
        .species = SPECIES_MARSHTOMP,
        .moves = {MOVE_MUDDY_WATER, MOVE_EARTH_POWER, MOVE_ENDEAVOR, MOVE_ICE_BEAM},
        .item = ITEM_UTILITY_UMBRELLA,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_PONYTA_2] = {
        .species = SPECIES_PONYTA,
        .moves = {MOVE_INFERNO, MOVE_BODY_SLAM, MOVE_LOW_KICK, MOVE_FLAME_CHARGE},
        .item = ITEM_BLUNDER_POLICY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_MAGCARGO_2] = {
        .species = SPECIES_MAGCARGO,
        .moves = {MOVE_OVERHEAT, MOVE_EARTH_POWER, MOVE_ANCIENT_POWER, MOVE_EXPLOSION},
        .item = ITEM_SHUCA_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    ...
    [FRONTIER_MON_RATICATE_2] = {
        .species = SPECIES_RATICATE,
        .moves = {MOVE_SUPER_FANG, MOVE_HYPER_FANG, MOVE_CRUNCH, MOVE_TORMENT},
        .item = ITEM_CHOPLE_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_MASQUERAIN_2] = {
        .species = SPECIES_MASQUERAIN,
        .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_GIGA_DRAIN, MOVE_BUG_BUZZ},
        .item = ITEM_EXPERT_BELT,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIET
    },
    ...
    [FRONTIER_MON_DUNSPARCE_2] = {
        .species = SPECIES_DUNSPARCE,
        .moves = {MOVE_AIR_SLASH, MOVE_DRILL_RUN, MOVE_ROOST, MOVE_GLARE},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_QUIET
    },
    [FRONTIER_MON_DRAGONAIR_2] = {
        .species = SPECIES_DRAGONAIR,
        .moves = {MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_DRAGON_PULSE, MOVE_SERPENT_DANCE},
    ...
    [FRONTIER_MON_LINOONE_2] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_SWITCHEROO, MOVE_FRUSTRATION, MOVE_THROAT_CHOP, MOVE_FLING},
        .item = ITEM_IRON_BALL,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
    ...
    [FRONTIER_MON_SHELGON_2] = {
        .species = SPECIES_SHELGON,
        .moves = {MOVE_ZEN_HEADBUTT, MOVE_DRAGON_DANCE, MOVE_CRUNCH, MOVE_DRAGON_CLAW},
    ...
    [FRONTIER_MON_WIGGLYTUFF_2] = {
        .species = SPECIES_WIGGLYTUFF,
        .moves = {MOVE_DRAIN_PUNCH, MOVE_SING, MOVE_DREAM_EATER, MOVE_DRAINING_KISS},
        .item = ITEM_BIG_ROOT,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_SUNFLORA_2] = {
        .species = SPECIES_SUNFLORA,
        .moves = {MOVE_SOLAR_BEAM, MOVE_EARTH_POWER, MOVE_GROWTH, MOVE_SUNNY_DAY},
        .item = ITEM_HEAT_ROCK,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FRONTIER_MON_CHIMECHO_2] = {
        .species = SPECIES_CHIMECHO,
        .moves = {MOVE_DAZZLING_GLEAM, MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_HEAL_BELL},
        .item = ITEM_TWISTED_SPOON,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FRONTIER_MON_GLIGAR_2] = {
        .species = SPECIES_GLIGAR,
        .moves = {MOVE_EARTHQUAKE, MOVE_POISON_JAB, MOVE_STEALTH_ROCK, MOVE_ROOST},
        .item = ITEM_EVIOLITE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_QWILFISH_2] = {
        .species = SPECIES_QWILFISH,
        .moves = {MOVE_REVENGE, MOVE_POISON_JAB, MOVE_AQUA_TAIL, MOVE_DESTINY_BOND},
        .item = ITEM_ROCKY_HELMET,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_SNEASEL_2] = {
        .species = SPECIES_SNEASEL,
        .moves = {MOVE_CRUSH_CLAW, MOVE_ICICLE_CRASH, MOVE_ROCK_SMASH, MOVE_SCREECH},
        .item = ITEM_EVIOLITE,
    ...
    [FRONTIER_MON_PELIPPER_2] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_BRINE, MOVE_SEED_BOMB, MOVE_HURRICANE, MOVE_TAILWIND},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    ...
    [FRONTIER_MON_LAIRON_2] = {
        .species = SPECIES_LAIRON,
        .moves = {MOVE_DRAGON_RUSH, MOVE_IRON_HEAD, MOVE_EARTHQUAKE, MOVE_ROCK_POLISH},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [FRONTIER_MON_TANGELA_2] = {
        .species = SPECIES_TANGELA,
        .moves = {MOVE_SEED_BOMB, MOVE_STUN_SPORE, MOVE_GRASSY_TERRAIN, MOVE_KNOCK_OFF},
        .item = ITEM_EVIOLITE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CALM
    },
    [FRONTIER_MON_ARBOK_2] = {
        .species = SPECIES_ARBOK,
        .moves = {MOVE_POISON_FANG, MOVE_EARTHQUAKE, MOVE_BREAKING_SWIPE, MOVE_GLARE},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_PERSIAN_2] = {
        .species = SPECIES_PERSIAN,
        .moves = {MOVE_PLAY_ROUGH, MOVE_THUNDERBOLT, MOVE_POWER_GEM, MOVE_TAUNT},
        .item = ITEM_FAIRY_GEM,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_SEADRA_2] = {
        .species = SPECIES_SEADRA,
        .moves = {MOVE_FLASH_CANNON, MOVE_SCALD, MOVE_DAZZLING_GLEAM, MOVE_SERPENT_DANCE},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_KECLEON_2] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_TRICK, MOVE_BRICK_BREAK, MOVE_SHADOW_CLAW, MOVE_SYNCHRONOISE},
        .item = ITEM_CHOICE_BAND,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_SOLROCK_2] = {
        .species = SPECIES_SOLROCK,
        .moves = {MOVE_ZEN_HEADBUTT, MOVE_ROCK_SLIDE, MOVE_COSMIC_POWER, MOVE_OVERHEAT},
    ...
    [FRONTIER_MON_NOCTOWL_2] = {
        .species = SPECIES_NOCTOWL,
        .moves = {MOVE_PSYCHIC, MOVE_MOONBLAST, MOVE_AIR_SLASH, MOVE_REFLECT},
        .item = ITEM_LIGHT_CLAY,
    ...
    [FRONTIER_MON_CHANSEY_2] = {
        .species = SPECIES_CHANSEY,
        .moves = {MOVE_SEISMIC_TOSS, MOVE_SHADOW_BALL, MOVE_TOXIC, MOVE_SOFT_BOILED},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_RELAXED
    },
    ...
    [FRONTIER_MON_JUMPLUFF_2] = {
        .species = SPECIES_JUMPLUFF,
        .moves = {MOVE_LEECH_SEED, MOVE_SLEEP_POWDER, MOVE_BOUNCE, MOVE_SUBSTITUTE},
        .item = ITEM_BIG_ROOT,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_IMPISH
    },
    [FRONTIER_MON_PILOSWINE_2] = {
        .species = SPECIES_PILOSWINE,
        .moves = {MOVE_THRASH, MOVE_ICICLE_SPEAR, MOVE_STEALTH_ROCK, MOVE_ROAR},
        .item = ITEM_OCCA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_GOLBAT_2] = {
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_AIR_SLASH},
        .item = ITEM_WISE_GLASSES,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_PRIMEAPE_2] = {
        .species = SPECIES_PRIMEAPE,
        .moves = {MOVE_CLOSE_COMBAT, MOVE_STOMPING_TANTRUM, MOVE_OVERHEAT, MOVE_BULK_UP},
    ...
    [FRONTIER_MON_HITMONLEE_2] = {
        .species = SPECIES_HITMONLEE,
        .moves = {MOVE_MEGA_KICK, MOVE_HIGH_JUMP_KICK, MOVE_BULK_UP, MOVE_BLAZE_KICK},
        .item = ITEM_MUSCLE_BAND,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_HITMONCHAN_2] = {
        .species = SPECIES_HITMONCHAN,
        .moves = {MOVE_FIRE_PUNCH, MOVE_SKY_UPPERCUT, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH},
        .item = ITEM_EXPERT_BELT,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_GIRAFARIG_2] = {
        .species = SPECIES_GIRAFARIG,
        .moves = {MOVE_PSYCHIC, MOVE_DARK_PULSE, MOVE_BATON_PASS, MOVE_AGILITY},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_HITMONTOP_2] = {
        .species = SPECIES_HITMONTOP,
        .moves = {MOVE_DOUBLE_EDGE, MOVE_CLOSE_COMBAT, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE},
        .item = ITEM_SILK_SCARF,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_NINJASK_2] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_BUG_BITE, MOVE_SUBSTITUTE, MOVE_SWORDS_DANCE, MOVE_BATON_PASS},
        .item = ITEM_GANLON_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_SEVIPER_2] = {
        .species = SPECIES_SEVIPER,
        .moves = {MOVE_SLUDGE_BOMB, MOVE_FLAMETHROWER, MOVE_SERPENT_DANCE, MOVE_GIGA_DRAIN},
        .item = ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_ZANGOOSE_2] = {
        .species = SPECIES_ZANGOOSE,
        .moves = {MOVE_SLASH, MOVE_SHADOW_CLAW, MOVE_CLOSE_COMBAT, MOVE_AERIAL_ACE},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_CAMERUPT_2] = {
        .species = SPECIES_CAMERUPT,
        .moves = {MOVE_EARTHQUAKE, MOVE_ERUPTION, MOVE_BODY_SLAM, MOVE_CURSE},
        .item = ITEM_WEAKNESS_POLICY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIRKY
    },
    [FRONTIER_MON_SHARPEDO_2] = {
        .species = SPECIES_SHARPEDO,
        .moves = {MOVE_ICE_FANG, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_WATERFALL},
        .item = ITEM_SAFETY_GOGGLES,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_MAGNETON_2] = {
        .species = SPECIES_MAGNETON,
        .moves = {MOVE_DISCHARGE, MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE, MOVE_MAGNET_RISE},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_MANTINE_2] = {
        .species = SPECIES_MANTINE,
        .moves = {MOVE_SURF, MOVE_AIR_SLASH, MOVE_RAIN_DANCE, MOVE_CONFUSE_RAY},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_STANTLER_2] = {
        .species = SPECIES_STANTLER,
        .moves = {MOVE_PSYSHOCK, MOVE_ENERGY_BALL, MOVE_THUNDERBOLT, MOVE_CALM_MIND},
        .item = ITEM_UTILITY_UMBRELLA,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_SP_ATTACK,
        .nature = NATURE_TIMID
    },
    ...
    [FRONTIER_MON_SWALOT_2] = {
        .species = SPECIES_SWALOT,
        .moves = {MOVE_SLUDGE_WAVE, MOVE_WRING_OUT, MOVE_PAIN_SPLIT, MOVE_COUNTER},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    ...
    [FRONTIER_MON_PIDGEOT_2] = {
        .species = SPECIES_PIDGEOT,
        .moves = {MOVE_HURRICANE, MOVE_REFLECT, MOVE_U_TURN, MOVE_ROOST},
    ...
    [FRONTIER_MON_GRUMPIG_2] = {
        .species = SPECIES_GRUMPIG,
        .moves = {MOVE_PSYSHOCK, MOVE_SNORE, MOVE_REST, MOVE_POWER_GEM},
        .item = ITEM_LEFTOVERS,
    ...
    [FRONTIER_MON_TORKOAL_2] = {
        .species = SPECIES_TORKOAL,
        .moves = {MOVE_HEAT_WAVE, MOVE_EARTH_POWER, MOVE_BODY_PRESS, MOVE_SOLAR_BEAM},
        .item = ITEM_CHARTI_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [FRONTIER_MON_KINGLER_2] = {
        .species = SPECIES_KINGLER,
        .moves = {MOVE_CRABHAMMER, MOVE_SUPERPOWER, MOVE_FLAIL, MOVE_ENDURE},
        .item = ITEM_SALAC_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_CACTURNE_2] = {
        .species = SPECIES_CACTURNE,
        .moves = {MOVE_ENERGY_BALL, MOVE_TEETER_DANCE, MOVE_SUCKER_PUNCH, MOVE_SPIKES},
        .item = ITEM_ROCKY_HELMET,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_OCTILLERY_2] = {
        .species = SPECIES_OCTILLERY,
        .moves = {MOVE_SURF, MOVE_FLAMETHROWER, MOVE_CHARGE_BEAM, MOVE_ICE_BEAM},
        .item = ITEM_EXPERT_BELT,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_OMASTAR_2] = {
        .species = SPECIES_OMASTAR,
        .moves = {MOVE_SCALD, MOVE_EARTH_POWER, MOVE_ICE_BEAM, MOVE_RAIN_DANCE},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_KABUTOPS_2] = {
        .species = SPECIES_KABUTOPS,
        .moves = {MOVE_WATERFALL, MOVE_FLINT_BLADE, MOVE_SUPERPOWER, MOVE_RAIN_DANCE},
        .item = ITEM_RINDO_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_PINSIR_2] = {
        .species = SPECIES_PINSIR,
        .moves = {MOVE_SUPERPOWER, MOVE_THRASH, MOVE_X_SCISSOR, MOVE_STONE_EDGE},
        .item = ITEM_MUSCLE_BAND,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_JOLLY
    },
    [FRONTIER_MON_POLITOED_2] = {
        .species = SPECIES_POLITOED,
        .moves = {MOVE_SURF, MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_ENCORE},
        .item = ITEM_LAX_INCENSE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_CLOYSTER_2] = {
        .species = SPECIES_CLOYSTER,
        .moves = {MOVE_SPIKE_CANNON, MOVE_ICICLE_SPEAR, MOVE_ROCK_BLAST, MOVE_TOXIC_SPIKES},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CAREFUL
    },
    ...
    [FRONTIER_MON_GALLADE_1] = {
        ...
        .moves = {MOVE_LOW_SWEEP, MOVE_PSYCHO_CUT, MOVE_THROAT_CHOP, MOVE_WILL_O_WISP},
        .item = ITEM_MUSCLE_BAND,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_CAREFUL
    },
    ...
    [FRONTIER_MON_MR_MIME_1] = {
        ...
        .moves = {MOVE_PSYCHIC, MOVE_ROLE_PLAY, MOVE_FAKE_OUT, MOVE_REFLECT},
        .item = ITEM_LIGHT_CLAY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    ...
    [FRONTIER_MON_FORRETRESS_1] = {
        ...
        .moves = {MOVE_IRON_HEAD, MOVE_TOXIC_SPIKES, MOVE_LIGHT_SCREEN, MOVE_SPIKES},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_QUAGSIRE_1] = {
        ...
        .moves = {MOVE_EARTH_POWER, MOVE_SCALD, MOVE_COUNTER, MOVE_ENCORE},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    [FRONTIER_MON_CLEFABLE_1] = {
        ...
        .moves = {MOVE_METRONOME, MOVE_SING, MOVE_REFLECT, MOVE_DRAINING_KISS},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_BRAVE
    },
    [FRONTIER_MON_HARIYAMA_1] = {
        ...
        .moves = {MOVE_CLOSE_COMBAT, MOVE_BULLET_PUNCH, MOVE_COUNTER, MOVE_FAKE_OUT},
        .item = ITEM_PAYAPA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_HYPNO_1] = {
        ...
        .moves = {MOVE_ZEN_HEADBUTT, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_FOCUS_PUNCH},
        .item = ITEM_TWISTED_SPOON,
    ...
    [FRONTIER_MON_SCIZOR_1] = {
        ...
        .moves = {MOVE_BULLET_PUNCH, MOVE_AERIAL_ACE, MOVE_ROOST, MOVE_ROCK_SMASH},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_HP | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_URSARING_1] = {
        ...
        .moves = {MOVE_THRASH, MOVE_CRUNCH, MOVE_HAMMER_ARM, MOVE_SCARY_FACE},
        .item = ITEM_FLAME_ORB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_HOUNDOOM_1] = {
        ...
        .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_SLUDGE_BOMB, MOVE_WILL_O_WISP},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_WAILORD_1] = {
        ...
        .moves = {MOVE_BRINE, MOVE_AVALANCHE, MOVE_SUBSTITUTE, MOVE_NOBLE_ROAR},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_SASSY
    },
    ...
    [FRONTIER_MON_MEGANIUM_1] = {
        ...
        .moves = {MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY, MOVE_WRING_OUT, MOVE_SYNTHESIS},
        .item = ITEM_OCCA_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_TYPHLOSION_1] = {
        ...
        .moves = {MOVE_FLAMETHROWER, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_DISCHARGE},
        .item = ITEM_SAFETY_GOGGLES,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_JOLLY
    },
    ...
    [FRONTIER_MON_GALLADE_2] = {
        .species = SPECIES_GALLADE,
        .moves = {MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_LEAF_BLADE, MOVE_STONE_EDGE},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_MISMAGIUS_2] = {
        .species = SPECIES_MISMAGIUS,
        .moves = {MOVE_HEX, MOVE_POWER_GEM, MOVE_MAGICAL_LEAF, MOVE_WILL_O_WISP},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_TIMID
    },
    ...
    [FRONTIER_MON_QUAGSIRE_2] = {
        .species = SPECIES_QUAGSIRE,
        .moves = {MOVE_EARTHQUAKE, MOVE_ATTRACT, MOVE_YAWN, MOVE_AQUA_TAIL},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_SASSY
    },
    ...
    [FRONTIER_MON_RAICHU_2] = {
        .species = SPECIES_RAICHU,
        .moves = {MOVE_THUNDERBOLT, MOVE_FOCUS_BLAST, MOVE_REFLECT, MOVE_ELECTROWEB},
        .item = ITEM_SHUCA_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_TIMID
    },
    ...
    [FRONTIER_MON_GLALIE_2] = {
        .species = SPECIES_GLALIE,
        .moves = {MOVE_EXPLOSION, MOVE_CRUNCH, MOVE_ICE_BEAM, MOVE_LIGHT_SCREEN},
        .item = ITEM_SALAC_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIRKY
    },
    ...
    [FRONTIER_MON_HYPNO_2] = {
        .species = SPECIES_HYPNO,
        .moves = {MOVE_HYPNOSIS, MOVE_NIGHTMARE, MOVE_DREAM_EATER, MOVE_PSYSHOCK},
        .item = ITEM_SAFETY_GOGGLES,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_KANGASKHAN_2] = {
        .species = SPECIES_KANGASKHAN,
        .moves = {MOVE_RETURN, MOVE_THUNDER_PUNCH, MOVE_AQUA_TAIL, MOVE_HAMMER_ARM},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_ARMALDO_2] = {
        .species = SPECIES_ARMALDO,
        .moves = {MOVE_LIQUIDATION, MOVE_FLINT_BLADE, MOVE_SUPERPOWER, MOVE_KNOCK_OFF},
        .item = ITEM_WEAKNESS_POLICY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_AMPHAROS_2] = {
        .species = SPECIES_AMPHAROS,
        .moves = {MOVE_THUNDERBOLT, MOVE_POWER_GEM, MOVE_SIGNAL_BEAM, MOVE_VOLT_SWITCH},
        .item = ITEM_AIR_BALLOON,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_SCIZOR_2] = {
        .species = SPECIES_SCIZOR,
        .moves = {MOVE_X_SCISSOR, MOVE_IRON_HEAD, MOVE_SWORDS_DANCE, MOVE_ACROBATICS},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_EXEGGUTOR_2] = {
        .species = SPECIES_EXEGGUTOR,
        .moves = {MOVE_WOOD_HAMMER, MOVE_CURSE, MOVE_SLEEP_POWDER, MOVE_ZEN_HEADBUTT},
        .item = ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_FLAREON_2] = {
        .species = SPECIES_FLAREON,
        .moves = {MOVE_OVERHEAT, MOVE_ATTRACT, MOVE_SHADOW_BALL, MOVE_REST},
        .item = ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [FRONTIER_MON_MEGANIUM_2] = {
        .species = SPECIES_MEGANIUM,
        .moves = {MOVE_LEECH_SEED, MOVE_SUBSTITUTE, MOVE_REFLECT, MOVE_GIGA_DRAIN},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CALM
    },
    ...
    [FRONTIER_MON_BLASTOISE_2] = {
        .species = SPECIES_BLASTOISE,
        .moves = {MOVE_WATER_PULSE, MOVE_ICE_BEAM, MOVE_FLASH_CANNON, MOVE_MIRROR_COAT},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    ...
    [FRONTIER_MON_SCEPTILE_2] = {
        .species = SPECIES_SCEPTILE,
        .moves = {MOVE_LEAF_BLADE, MOVE_EARTHQUAKE, MOVE_ATTRACT, MOVE_DRAGON_CLAW},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_JOLLY
    },
    ...
    [FRONTIER_MON_LEAFEON_3] = {
        .species = SPECIES_LEAFEON,
        .moves = {MOVE_LEAF_BLADE, MOVE_FLINT_BLADE, MOVE_KNOCK_OFF, MOVE_TOPSY_TURVY},
        .item = ITEM_DARK_GEM,
        .evSpread = F_EV_SPREAD_HP | F_EV_SPREAD_SPEED,
        .nature = NATURE_JOLLY
    },
    ...
    [FRONTIER_MON_TOGEKISS_3] = {
        .species = SPECIES_TOGEKISS,
        .moves = {MOVE_DAZZLING_GLEAM, MOVE_PSYSHOCK, MOVE_NASTY_PLOT, MOVE_BATON_PASS},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_HP | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_BOLD
    },
    ...
    [FRONTIER_MON_HONCHKROW_3] = {
        .species = SPECIES_HONCHKROW,
        .moves = {MOVE_NIGHT_SLASH, MOVE_STEEL_WING, MOVE_BRAVE_BIRD, MOVE_TAILWIND},
        .item = ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_WEAVILE_3] = {
        .species = SPECIES_WEAVILE,
        .moves = {MOVE_ICICLE_CRASH, MOVE_THROAT_CHOP, MOVE_IRON_TAIL, MOVE_TAUNT},
        .item = ITEM_STEEL_GEM,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_QUAGSIRE_3] = {
        .species = SPECIES_QUAGSIRE,
        .moves = {MOVE_EARTHQUAKE, MOVE_WATERFALL, MOVE_STONE_EDGE, MOVE_RECOVER},
        .item = ITEM_ROCKY_HELMET,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_RAICHU_3] = {
        .species = SPECIES_RAICHU,
        .moves = {MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_DRAINING_KISS, MOVE_ATTRACT},
        .item = ITEM_AIR_BALLOON,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_MANECTRIC_3] = {
        .species = SPECIES_MANECTRIC,
        .moves = {MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_CHARGE_BEAM, MOVE_ELECTROWEB},
        .item = ITEM_WISE_GLASSES,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_TIMID
    },
    ...
    [FRONTIER_MON_ELECTRODE_3] = {
        .species = SPECIES_ELECTRODE,
        .moves = {MOVE_EXPLOSION, MOVE_THUNDERBOLT, MOVE_MAGIC_COAT, MOVE_ENDURE},
        .item = ITEM_LIECHI_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    ...
    [FRONTIER_MON_SCIZOR_3] = {
        .species = SPECIES_SCIZOR,
        .moves = {MOVE_BULLET_PUNCH, MOVE_BRICK_BREAK, MOVE_PURSUIT, MOVE_U_TURN},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_CAREFUL
    },
    ...
    [FRONTIER_MON_STEELIX_3] = {
        .species = SPECIES_STEELIX,
        .moves = {MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM, MOVE_HEAD_SMASH, MOVE_BODY_PRESS},
        .item = ITEM_LIECHI_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_PORYGON2_3] = {
        .species = SPECIES_PORYGON2,
        .moves = {MOVE_CHARGE_BEAM, MOVE_TRI_ATTACK, MOVE_ELECTROWEB, MOVE_RECOVER},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    ...
    [FRONTIER_MON_VAPOREON_3] = {
        .species = SPECIES_VAPOREON,
        .moves = {MOVE_MUDDY_WATER, MOVE_STORED_POWER, MOVE_ACID_ARMOR, MOVE_REST},
        .item = ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CALM
    },
    ...
    [FRONTIER_MON_SCEPTILE_3] = {
        .species = SPECIES_SCEPTILE,
        .moves = {MOVE_LEAF_BLADE, MOVE_THUNDER_PUNCH, MOVE_X_SCISSOR, MOVE_ACROBATICS},
        .item = ITEM_FOCUS_SASH,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_PROBOPASS_4] = {
        .species = SPECIES_PROBOPASS,
        .moves = {MOVE_POWER_GEM, MOVE_EARTH_POWER, MOVE_VOLT_SWITCH, MOVE_SANDSTORM},
        .item = ITEM_SMOOTH_ROCK,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    ...
    [FRONTIER_MON_ELECTIVIRE_4] = {
        .species = SPECIES_ELECTIVIRE,
        .moves = {MOVE_WILD_CHARGE, MOVE_BRICK_BREAK, MOVE_ICE_PUNCH, MOVE_ELECTROWEB},
        .item = ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
    ...
    [FRONTIER_MON_LEAFEON_4] = {
        .species = SPECIES_LEAFEON,
        .moves = {MOVE_LEAF_BLADE, MOVE_FLINT_BLADE, MOVE_SYNTHESIS, MOVE_SUNNY_DAY},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_BRELOOM_4] = {
        .species = SPECIES_BRELOOM,
        .moves = {MOVE_FOCUS_PUNCH, MOVE_SEED_BOMB, MOVE_SPORE, MOVE_THUNDER_PUNCH},
        .item = ITEM_TOXIC_ORB,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_QUAGSIRE_4] = {
        .species = SPECIES_QUAGSIRE,
        .moves = {MOVE_EARTHQUAKE, MOVE_AQUA_TAIL, MOVE_ICE_PUNCH, MOVE_CURSE},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_SASSY
    },
    ...
    [FRONTIER_MON_RAPIDASH_4] = {
        .species = SPECIES_RAPIDASH,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_THROAT_CHOP, MOVE_REFLECT, MOVE_LOW_KICK},
        .item = ITEM_WHITE_HERB,
        .evSpread = F_EV_SPREAD_HP | F_EV_SPREAD_ATTACK,
        .nature = NATURE_IMPISH
    },
    ...
    [FRONTIER_MON_AMPHAROS_4] = {
        .species = SPECIES_AMPHAROS,
        .moves = {MOVE_THUNDERBOLT, MOVE_DRAGON_PULSE, MOVE_POWER_GEM, MOVE_TAIL_GLOW},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_SCIZOR_4] = {
        .species = SPECIES_SCIZOR,
        .moves = {MOVE_BULLET_PUNCH, MOVE_SWORDS_DANCE, MOVE_ROCK_SMASH, MOVE_BATON_PASS},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CAREFUL
    },
    ...
    [FRONTIER_MON_URSARING_4] = {
        .species = SPECIES_URSARING,
        .moves = {MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_NIGHT_SLASH, MOVE_AVALANCHE},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_DONPHAN_4] = {
        .species = SPECIES_DONPHAN,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_KNOCK_OFF},
        .item = ITEM_SNOWBALL,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_WAILORD_4] = {
        .species = SPECIES_WAILORD,
        .moves = {MOVE_WATERFALL, MOVE_BOUNCE, MOVE_EARTHQUAKE, MOVE_ICE_BEAM},
        .item = ITEM_ASSAULT_VEST,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_EXEGGUTOR_4] = {
        .species = SPECIES_EXEGGUTOR,
        .moves = {MOVE_LEAF_STORM, MOVE_SLEEP_POWDER, MOVE_WORRY_SEED, MOVE_EXPLOSION},
        .item = ITEM_GRASS_GEM,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_HARDY
    },
    ...
    [FRONTIER_MON_FLAREON_4] = {
        .species = SPECIES_FLAREON,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_OVERHEAT, MOVE_SUPERPOWER, MOVE_STORED_POWER},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_HP | F_EV_SPREAD_ATTACK,
        .nature = NATURE_SERIOUS
    },
    ...
    [FRONTIER_MON_BLASTOISE_4] = {
        .species = SPECIES_BLASTOISE,
        .moves = {MOVE_WATER_PULSE, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_DARK_PULSE},
        .item = ITEM_WISE_GLASSES,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_ARTICUNO_1] = {
        ...
        .moves = {MOVE_BLIZZARD, MOVE_WATER_PULSE, MOVE_AURORA_VEIL, MOVE_HAIL},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_RAIKOU_1] = {
        ...
        .moves = {MOVE_THUNDERBOLT, MOVE_EXTRASENSORY, MOVE_CALM_MIND, MOVE_REST},
        .item = ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_HP | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_ENTEI_1] = {
        ...
        .moves = {MOVE_BLAZE_IMPACT, MOVE_IRON_TAIL, MOVE_STONE_EDGE, MOVE_SUBSTITUTE},
        .item = ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_ZAPDOS_2] = {
        .species = SPECIES_ZAPDOS,
        .moves = {MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_THUNDER_WAVE, MOVE_DRILL_PECK},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_MOLTRES_2] = {
        .species = SPECIES_MOLTRES,
        .moves = {MOVE_OVERHEAT, MOVE_AERIAL_ACE, MOVE_U_TURN, MOVE_BLAZE_IMPACT},
        .item = ITEM_WHITE_HERB,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    [FRONTIER_MON_RAIKOU_2] = {
        .species = SPECIES_RAIKOU,
        .moves = {MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_SIGNAL_BEAM, MOVE_SHADOW_BALL},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_ENTEI_2] = {
        .species = SPECIES_ENTEI,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_DIG, MOVE_STONE_EDGE, MOVE_OVERHEAT},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_SERIOUS
    },
    ...
    [FRONTIER_MON_MOLTRES_3] = {
        .species = SPECIES_MOLTRES,
        .moves = {MOVE_FIRE_BLAST, MOVE_HURRICANE, MOVE_REFLECT, MOVE_ROOST},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_SUICUNE_3] = {
        .species = SPECIES_SUICUNE,
        .moves = {MOVE_SCALD, MOVE_ICE_BEAM, MOVE_RAIN_DANCE, MOVE_TAILWIND},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_ZAPDOS_4] = {
        .species = SPECIES_ZAPDOS,
        .moves = {MOVE_THUNDER, MOVE_HEAT_WAVE, MOVE_SIGNAL_BEAM, MOVE_LIGHT_SCREEN},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    ...
    [FRONTIER_MON_RAIKOU_4] = {
        .species = SPECIES_RAIKOU,
        .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_THUNDER_WAVE, MOVE_SIGNAL_BEAM},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_ENTEI_4] = {
        .species = SPECIES_ENTEI,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_BULLDOZE, MOVE_IRON_HEAD, MOVE_REFLECT},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_SUICUNE_4] = {
        .species = SPECIES_SUICUNE,
        .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_EXTRASENSORY, MOVE_REFLECT},
        .item = ITEM_LIGHT_CLAY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_GENGAR_5] = {
        .species = SPECIES_GENGAR,
        .moves = {MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_SKILL_SWAP},
        .item = ITEM_HEAVY_DUTY_BOOTS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_GENGAR_6] = {
        .species = SPECIES_GENGAR,
        .moves = {MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_DAZZLING_GLEAM},
        .item = ITEM_BLACK_SLUDGE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_URSARING_5] = {
        .species = SPECIES_URSARING,
        .moves = {MOVE_THUNDER_PUNCH, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_CLOSE_COMBAT},
        .item = ITEM_CHOICE_BAND,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_URSARING_6] = {
        .species = SPECIES_URSARING,
        .moves = {MOVE_FACADE, MOVE_YAWN, MOVE_SWORDS_DANCE, MOVE_HAMMER_ARM},
        .item = ITEM_FLAME_ORB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FRONTIER_MON_URSARING_7] = {
        .species = SPECIES_URSARING,
        .moves = {MOVE_THRASH, MOVE_HAMMER_ARM, MOVE_PAYBACK, MOVE_BULK_UP},
        .item = ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_URSARING_8] = {
        .species = SPECIES_URSARING,
        .moves = {MOVE_FACADE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_FIRE_PUNCH},
        .item = ITEM_FLAME_ORB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_DOCILE
    },
    ...
    [FRONTIER_MON_SALAMENCE_8] = {
        .species = SPECIES_SALAMENCE,
        .moves = {MOVE_FLY, MOVE_DRAGON_CLAW, MOVE_CRUNCH, MOVE_ATTRACT},
        .item = ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_DRAGONITE_4] = {
        .species = SPECIES_DRAGONITE,
        .moves = {MOVE_DRAGON_PULSE, MOVE_HEAT_WAVE, MOVE_THUNDERBOLT, MOVE_SERPENT_DANCE},
        .item = ITEM_DRAGON_GEM,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FRONTIER_MON_DRAGONITE_7] = {
        .species = SPECIES_DRAGONITE,
        .moves = {MOVE_HURRICANE, MOVE_FIRE_BLAST, MOVE_SURF, MOVE_SERPENT_DANCE},
        .item = ITEM_SHELL_BELL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    ...
    [FRONTIER_MON_ZAPDOS_6] = {
        .species = SPECIES_ZAPDOS,
        .moves = {MOVE_THUNDER, MOVE_HEAT_WAVE, MOVE_REFLECT, MOVE_SIGNAL_BEAM},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_TIMID
    },
    ...
    [FRONTIER_MON_MOLTRES_6] = {
        .species = SPECIES_MOLTRES,
        .moves = {MOVE_FIRE_BLAST, MOVE_HURRICANE, MOVE_AERIAL_ACE, MOVE_STEEL_WING},
        .item = ITEM_FLYING_GEM,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_RAIKOU_5] = {
        .species = SPECIES_RAIKOU,
        .moves = {MOVE_THUNDERBOLT, MOVE_EXTRASENSORY, MOVE_SNARL, MOVE_REFLECT},
        .item = ITEM_MAGNET,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_RAIKOU_6] = {
        .species = SPECIES_RAIKOU,
        .moves = {MOVE_THUNDERBOLT, MOVE_SIGNAL_BEAM, MOVE_SHADOW_BALL, MOVE_LIGHT_SCREEN},
        .item = ITEM_SAFETY_GOGGLES,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_ENTEI_5] = {
        .species = SPECIES_ENTEI,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_STONE_EDGE, MOVE_OVERHEAT, MOVE_WILL_O_WISP},
        .item = ITEM_SHUCA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_DOCILE
    },
    [FRONTIER_MON_ENTEI_6] = {
        .species = SPECIES_ENTEI,
        .moves = {MOVE_BLAZE_IMPACT, MOVE_IRON_HEAD, MOVE_BODY_SLAM, MOVE_REST},
        .item = ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    [FRONTIER_MON_SUICUNE_5] = {
        .species = SPECIES_SUICUNE,
        .moves = {MOVE_SCALD, MOVE_ICE_BEAM, MOVE_CALM_MIND, MOVE_SIGNAL_BEAM},
        .item = ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FRONTIER_MON_SUICUNE_6] = {
        .species = SPECIES_SUICUNE,
        .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_REST, MOVE_MIRROR_COAT},
        .item = ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    }
