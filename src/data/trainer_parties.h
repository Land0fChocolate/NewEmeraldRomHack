static const struct TrainerMonNoItemDefaultMoves sParty_Sawyer[] = {
    {
    .iv = 0,
    .lvl = 23,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gomez1[] = {
    {
    .iv = 0,
    .lvl = 30,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gomez2[] = {
    {
    .iv = 0,
    .lvl = 38,
    .species = SPECIES_CACTURNE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gomez3[] = {
    {
    .iv = 0,
    .lvl = 41,
    .species = SPECIES_CACTURNE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gomez4[] = {
    {
    .iv = 0,
    .lvl = 44,
    .species = SPECIES_CACTURNE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gomez5[] = {
    {
    .iv = 0,
    .lvl = 48,
    .species = SPECIES_CACTURNE,
...
static const struct TrainerMonItemCustomMoves sParty_Matt[] = {
    ...
    .moves = {MOVE_BRINE, MOVE_AVALANCHE, MOVE_ROCK_SMASH, MOVE_RAIN_DANCE},
    },
    {
    .iv = 100,
    .lvl = 37,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_FANG, MOVE_LEECH_LIFE, MOVE_CONFUSE_RAY, MOVE_ACROBATICS},
    },
    {
    .iv = 100,
    .lvl = 39,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRINE, MOVE_AVALANCHE, MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM},
    },
};

static const struct TrainerMonNoItemCustomMoves sParty_KatAndAshe[] = {
    {
    .iv = 70,
    .lvl = 51,
    .species = SPECIES_RAICHU_ALOLAN,
    .moves = {MOVE_DISCHARGE, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_GRASS_KNOT}
    },
    {
    .iv = 200,
    .lvl = 53,
    .species = SPECIES_RHYPERIOR,
    .moves = {MOVE_DRILL_RUN, MOVE_STONE_EDGE, MOVE_BRICK_BREAK, MOVE_ROCK_POLISH}
    },
    {
    .iv = 70,
    .lvl = 51,
    .species = SPECIES_RAPIDASH,
    .moves = {MOVE_FLARE_BLITZ, MOVE_BOUNCE, MOVE_MEGAHORN, MOVE_FIRE_BLAST}
    },
    {
    .iv = 200,
    .lvl = 53,
    .species = SPECIES_HITMONTOP,
    .moves = {MOVE_TRIPLE_KICK, MOVE_BULLET_PUNCH, MOVE_STONE_EDGE, MOVE_DIG}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_ArchieWeatherInstitute[] = {
    {
    .iv = 180,
    .lvl = 34,
    .species = SPECIES_MIGHTYENA,
    ...
    .moves = {MOVE_BITE, MOVE_ICE_FANG, MOVE_AQUA_JET, MOVE_SURF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Archie[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_POISON_FANG, MOVE_HOWL}
    },
    {
    .iv = 200,
    .lvl = 43,
    ...
    .moves = {MOVE_AQUA_TAIL, MOVE_DRAGON_TAIL, MOVE_THRASH, MOVE_ICE_FANG}
    },
    {
    .iv = 200,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CROSS_POISON, MOVE_CONFUSE_RAY, MOVE_LEECH_LIFE, MOVE_ACROBATICS}
    },
    {
    .iv = 220,
    .lvl = 45,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Geordi[] = {
    {
    .iv = 0,
    .lvl = 52,
...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 0,
    .lvl = 44,
    .species = SPECIES_GRUMPIG,
    .moves = {MOVE_CONFUSE_RAY, MOVE_TEETER_DANCE, MOVE_POWER_GEM, MOVE_PSYSHOCK}
    },
    {
    .iv = 0,
    .lvl = 45,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_EXTRASENSORY, MOVE_COSMIC_POWER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty2[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_BULLDOZE, MOVE_CRUSH_CLAW, MOVE_SAND_ATTACK, MOVE_POISON_STING}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty3[] = {
    ...
    .lvl = 31,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_ANCIENT_POWER, MOVE_PSYBEAM, MOVE_POWER_TRICK, MOVE_COSMIC_POWER}
    },
    {
    .iv = 70,
    .lvl = 31,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_BULLDOZE, MOVE_SLASH, MOVE_RAPID_SPIN, MOVE_POISON_STING}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty4[] = {
    ...
    .lvl = 34,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_ANCIENT_POWER, MOVE_EXTRASENSORY, MOVE_POWER_TRICK, MOVE_COSMIC_POWER}
    },
    {
    .iv = 80,
    .lvl = 34,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_BULLDOZE, MOVE_SLASH, MOVE_RAPID_SPIN, MOVE_POISON_JAB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty5[] = {
    ...
    .lvl = 37,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_ANCIENT_POWER, MOVE_EXTRASENSORY, MOVE_POWER_SPLIT, MOVE_COSMIC_POWER}
    },
    {
    .iv = 90,
    .lvl = 37,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_EARTHQUAKE, MOVE_SLASH, MOVE_RAPID_SPIN, MOVE_POISON_JAB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_STOMP, MOVE_SUPERSONIC, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = {MOVE_REST, MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_ROCK_SMASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_REVENGE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_POWER_GEM, MOVE_BUBBLE_BEAM, MOVE_BLIZZARD, MOVE_RECOVER}
    },
    {
    .iv = 100,
    .lvl = 41,
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_HEAL_PULSE, MOVE_RAIN_DANCE, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy2[] = {
    ...
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_TOXIC, MOVE_VENOSHOCK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_GIGA_DRAIN, MOVE_DRAINING_KISS, MOVE_VENOSHOCK, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winston5[] = {
    ...
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_GIGA_IMPACT, MOVE_THUNDER, MOVE_SUCKER_PUNCH, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Alistair[] = {
    {
    .iv = 100,
    .lvl = 52,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kylie[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_MIGHTYENA,
...
static const struct TrainerMonNoItemCustomMoves sParty_Jaclyn[] = {
    ...
    .lvl = 17,
    .species = SPECIES_ABRA,
    .moves = {MOVE_HIDDEN_POWER, MOVE_CHARGE_BEAM, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kayla[] = {
    ...
    .lvl = 31,
    .species = SPECIES_ABRA,
    .moves = {MOVE_PSYCHIC, MOVE_SKILL_SWAP, MOVE_CHARGE_BEAM, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 0,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_THROAT_CHOP, MOVE_LEAF_BLADE, MOVE_EXTRASENSORY}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .moves = {MOVE_STONE_EDGE, MOVE_PLAY_ROUGH, MOVE_SWORDS_DANCE, MOVE_SUCKER_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .moves = {MOVE_SHADOW_CLAW, MOVE_GUNK_SHOT, MOVE_SUCKER_PUNCH, MOVE_TRICK_ROOM}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_DUSKNOIR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_SHADOW_SNEAK, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .moves = {MOVE_LIGHT_SCREEN, MOVE_EXPLOSION, MOVE_ICE_SHARD, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .moves = {MOVE_ATTRACT, MOVE_SHADOW_BALL, MOVE_DRAINING_KISS, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .moves = {MOVE_HURRICANE, MOVE_DRAGON_PULSE, MOVE_PERISH_SONG, MOVE_MOONBLAST}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_SCREECH}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .species = SPECIES_FLYGON,
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_FLAMETHROWER, MOVE_BOOMBURST, MOVE_DRAGON_PULSE, MOVE_EARTH_POWER}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FIRE_FANG, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_THUNDER_FANG}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_WHIRLWIND, MOVE_BRAVE_BIRD, MOVE_STEALTH_ROCK, MOVE_STEEL_WING}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_MUSCLE_BAND,
    .moves = {MOVE_HEAVY_SLAM, MOVE_EARTHQUAKE, MOVE_HEAD_SMASH, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .moves = {MOVE_AQUA_JET, MOVE_FLINT_BLADE, MOVE_BUG_BITE, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_METAL_CLAW, MOVE_MUD_SLAP, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 14,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_FANG, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_HOWL}
    },
    {
    .iv = 220,
    .lvl = 23,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FACADE, MOVE_CURSE, MOVE_FEINT_ATTACK, MOVE_ENCORE}
    },
    {
    .iv = 220,
    .lvl = 31,
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FACADE, MOVE_ROCK_SLIDE, MOVE_ENCORE, MOVE_BRICK_BREAK}
    },
    {
    .iv = 250,
    .lvl = 33,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BRICK_BREAK, MOVE_SLACK_OFF, MOVE_FACADE, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .moves = {MOVE_BUG_BUZZ, MOVE_AIR_CUTTER, MOVE_ICE_BEAM, MOVE_TAILWIND}
    },
    {
    .iv = 220,
    .lvl = 35,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_EARTHQUAKE, MOVE_BODY_PRESS, MOVE_ZEN_HEADBUTT, MOVE_REFLECT}
    },
    {
    .iv = 250,
    .lvl = 42,
    .species = SPECIES_XATU,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHIC, MOVE_AIR_SLASH, MOVE_TAILWIND, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 44,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_GRASS_KNOT, MOVE_ICE_BEAM, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 44,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_ROCK_SLIDE, MOVE_FLARE_BLITZ, MOVE_REFLECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace1[] = {
    ...
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_REST, MOVE_AQUA_TAIL, MOVE_AMNESIA, MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_BIG_ROOT,
    .moves = {MOVE_WATER_PULSE, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_RAIN_DANCE}
    },
    {
    .iv = 250,
    .lvl = 48,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_SERPENT_DANCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 18,
    .species = SPECIES_MAKUHITA,
    .moves = {MOVE_TACKLE, MOVE_FOCUS_ENERGY, MOVE_ARM_THRUST, MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 19,
    .species = SPECIES_ELECTRIKE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDER_FANG, MOVE_QUICK_ATTACK, MOVE_HOWL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .moves = {MOVE_NUZZLE, MOVE_GRASS_KNOT, MOVE_THUNDERBOLT, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .lvl = 45,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_EARTHQUAKE, MOVE_SHADOW_BALL, MOVE_SECRET_POWER, MOVE_BRICK_BREAK}
    },
    {
    .iv = 100,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Juan[] = {
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_SURF, MOVE_AIR_SLASH, MOVE_U_TURN, MOVE_TAILWIND}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_HYDRO_PUMP, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAZOR_SHELL, MOVE_NIGHT_SLASH, MOVE_BRICK_BREAK, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Isaiah[] = {
    {
    .iv = 0,
    .lvl = 36,
    .species = SPECIES_STARYU,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Natasha[] = {
    {
    .iv = 100,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_FLAMETHROWER, MOVE_TAUNT, MOVE_EXPLOSION}
    },
    {
    .iv = 0,
    .lvl = 46,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_WATER_PULSE, MOVE_SIGNAL_BEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 18,
    .species = SPECIES_GULPIN,
    .moves = {MOVE_YAWN, MOVE_SLUDGE, MOVE_ACID_SPRAY, MOVE_BULLET_SEED}
    },
    {
    .iv = 0,
    .lvl = 18,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao2[] = {
    ...
    .lvl = 24,
    .species = SPECIES_GULPIN,
    .moves = {MOVE_YAWN, MOVE_SLUDGE, MOVE_ENCORE, MOVE_BULLET_SEED}
    },
    {
    .iv = 0,
    .lvl = 24,
    ...
    .lvl = 26,
    .species = SPECIES_GULPIN,
    .moves = {MOVE_YAWN, MOVE_SLUDGE, MOVE_TOXIC, MOVE_BULLET_SEED}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lao5[] = {
    ...
    .species = SPECIES_KOFFING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_GYRO_BALL, MOVE_SLUDGE, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 40,
    .lvl = 35,
    .species = SPECIES_SWALOT,
    .moves = {MOVE_YAWN, MOVE_SLUDGE_WAVE, MOVE_TOXIC, MOVE_BULLET_SEED}
    },
    {
    .iv = 40,
    .lvl = 35,
    ...
    .moves = {MOVE_DOUBLE_HIT, MOVE_SLUDGE_BOMB, MOVE_GYRO_BALL, MOVE_SELF_DESTRUCT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Annika[] = {
    ...
    .moves = {MOVE_SUCKER_PUNCH, MOVE_AQUA_TAIL, MOVE_SCARY_FACE, MOVE_ICE_FANG}
    },
    {
    .iv = 100,
    .lvl = 40,
    .species = SPECIES_LANTURN,
    .moves = {MOVE_THUNDERBOLT, MOVE_WATER_PULSE, MOVE_CONFUSE_RAY, MOVE_EERIE_IMPULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_STEEL_WING, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 200,
    .lvl = 48,
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_AQUA_JET, MOVE_PLAY_ROUGH, MOVE_AQUA_TAIL, MOVE_BRICK_BREAK}
    },
    {
    .iv = 200,
    .lvl = 48,
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_PETAL_DANCE, MOVE_LEECH_SEED, MOVE_SLUDGE_BOMB, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = 200,
    .lvl = 48,
    ...
    .moves = {MOVE_FLASH_CANNON, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 250,
    .lvl = 50,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Hannibal[] = {
    {
    .iv = 50,
    .lvl = 30,
    .species = SPECIES_CRAWDAUNT,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMagmaHideout[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_CRUNCH, MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_SWAGGER}
    },
    {
    .iv = 200,
    .lvl = 38,
    ...
    .heldItem = ITEM_MUSCLE_BAND,
    .moves = {MOVE_EARTHQUAKE, MOVE_THUNDER_FANG, MOVE_KNOCK_OFF, MOVE_FLAIL}
    },
    {
    .iv = 200,
    .lvl = 38,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CROSS_POISON, MOVE_HYPNOSIS, MOVE_GIGA_DRAIN, MOVE_ACROBATICS}
    },
    {
    .iv = 220,
    .lvl = 40,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_CURSE, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    .lvl = 26,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_BITE, MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_SWAGGER}
    },
    {
    .iv = 180,
    .lvl = 26,
    .species = SPECIES_GOLBAT,
    .moves = {MOVE_POISON_FANG, MOVE_HYPNOSIS, MOVE_AIR_CUTTER, MOVE_SCREECH}
    },
    {
    .iv = 180,
    .lvl = 28,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jaylin[] = {
    {
    .iv = 0,
    .lvl = 18,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Pitaha[] = {
    {
    .iv = 0,
    .lvl = 52,
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 25,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_MEDITATE, MOVE_DETECT, MOVE_CONFUSION, MOVE_FIRE_PUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .lvl = 29,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SLASH, MOVE_DOUBLE_TEAM, MOVE_BUG_BITE, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    ...
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_AQUA_JET, MOVE_PLAY_ROUGH, MOVE_AQUA_TAIL, MOVE_SUPERPOWER}
    },
    {
    .iv = 200,
    .lvl = 52,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanMossdeepMudkip[] = {
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanMossdeepTreecko[] = {
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanMossdeepTorchic[] = {
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_MayMossdeepMudkip[] = {
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_MayMossdeepTreecko[] = {
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_MayMossdeepTorchic[] = {
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Koji[] = {
    {
    .iv = 0,
    .lvl = 37,
    .species = SPECIES_MACHOKE,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 33,
    .species = SPECIES_SWABLU,
    .moves = {MOVE_SING, MOVE_ECHOED_VOICE, MOVE_MIRROR_MOVE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 0,
    .lvl = 35,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Destinee[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_SABLEYE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Blair[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_POOCHYENA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Miley[] = {
    {
    .iv = 0,
    .lvl = 26,
    .species = SPECIES_CACNEA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sharlene1[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_SHARPEDO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sharlene2[] = {
    {
    .iv = 0,
    .lvl = 38,
    .species = SPECIES_SHARPEDO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sharlene3[] = {
    {
    .iv = 0,
    .lvl = 41,
    .species = SPECIES_SHARPEDO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sharlene4[] = {
    {
    .iv = 0,
    .lvl = 44,
    .species = SPECIES_SHARPEDO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Sharlene5[] = {
    {
    .iv = 0,
    .lvl = 48,
    .species = SPECIES_SHARPEDO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_RitaAndSam[] = {
    {
    .iv = 0,
    .lvl = 54,
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 31,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDER, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_SNARL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .moves = {MOVE_SELF_DESTRUCT, MOVE_SMACK_DOWN, MOVE_BULLDOZE, MOVE_SANDSTORM}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ICE_BEAM, MOVE_AQUA_JET, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_DRILL_RUN, MOVE_STEALTH_ROCK, MOVE_ROAR, MOVE_STONE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POWER_GEM, MOVE_DISCHARGE, MOVE_EARTH_POWER, MOVE_FLASH_CANNON}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .heldItem = ITEM_SMOOTH_ROCK,
    .moves = {MOVE_SANDSTORM, MOVE_ICE_BEAM, MOVE_ANCIENT_POWER, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .species = SPECIES_KABUTOPS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_LIQUIDATION, MOVE_FLINT_BLADE}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .species = SPECIES_GOLEM,
    .heldItem = ITEM_SMOOTH_ROCK,
    .moves = {MOVE_EXPLOSION, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_SANDSTORM}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .species = SPECIES_GOLEM,
    .heldItem = ITEM_SMOOTH_ROCK,
    .moves = {MOVE_SANDSTORM, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 59,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_HIGH_JUMP_KICK, MOVE_ICE_PUNCH, MOVE_RECOVER}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_BULLET_PUNCH, MOVE_DIG, MOVE_SUCKER_PUNCH, MOVE_TRIPLE_KICK}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_VITAL_THROW, MOVE_BELLY_DRUM, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = {
    ...
    .species = SPECIES_HITMONTOP,
    .heldItem = ITEM_DARK_GEM,
    .moves = {MOVE_BULLET_PUNCH, MOVE_EARTHQUAKE, MOVE_SUCKER_PUNCH, MOVE_CLOSE_COMBAT}
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HEAVY_SLAM, MOVE_BRICK_BREAK, MOVE_BELLY_DRUM, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_MEGA_KICK, MOVE_HIGH_JUMP_KICK, MOVE_EARTHQUAKE, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 59,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .moves = {MOVE_THUNDER, MOVE_POWER_GEM, MOVE_THUNDER_WAVE, MOVE_CHARGE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_REFLECT, MOVE_FLASH_CANNON, MOVE_THUNDER, MOVE_CHARGE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_SNARL, MOVE_THUNDERBOLT, MOVE_CHARGE_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = {
    ...
    .species = SPECIES_AMPHAROS,
    .heldItem = ITEM_SHUCA_BERRY,
    .moves = {MOVE_THUNDER, MOVE_POWER_GEM, MOVE_SIGNAL_BEAM, MOVE_CHARGE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    .species = SPECIES_ELECTIVIRE,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_FIRE_PUNCH, MOVE_BRICK_BREAK, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson5[] = {
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_ELECTRIC_TERRAIN, MOVE_PSYCHIC, MOVE_GRASS_KNOT}
    },
    {
    .iv = 255,
    .lvl = 59,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_EARTHQUAKE, MOVE_STONE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_BODY_PRESS, MOVE_SOLAR_BEAM, MOVE_EARTH_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = {
    ...
    .species = SPECIES_RAPIDASH,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_FLAMETHROWER, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_HIGH_HORSEPOWER}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_SHUCA_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_CRUNCH, MOVE_DOUBLE_EDGE, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = {
    ...
    .heldItem = ITEM_SHUCA_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_HEAD_SMASH, MOVE_WILD_CHARGE, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery5[] = {
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LAVA_PLUME, MOVE_SUNNY_DAY, MOVE_EARTHQUAKE, MOVE_STONE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 61,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FACADE, MOVE_ROCK_SLIDE, MOVE_SHADOW_CLAW, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_SING, MOVE_SKILL_SWAP, MOVE_LIFE_DEW}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_KNOCK_OFF, MOVE_BODY_SLAM, MOVE_DRAIN_PUNCH, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GIGA_IMPACT, MOVE_HAMMER_ARM, MOVE_PLAY_ROUGH, MOVE_SLACK_OFF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman4[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FACADE, MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GIGA_IMPACT, MOVE_ROCK_SLIDE, MOVE_SHADOW_CLAW, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 59,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_OUTRAGE, MOVE_AQUA_TAIL, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 59,
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .species = SPECIES_MURKROW,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_AERIAL_ACE, MOVE_MEAN_LOOK, MOVE_PERISH_SONG}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_MASQUERAIN,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_BUG_BUZZ, MOVE_AIR_SLASH, MOVE_ICE_BEAM, MOVE_TAILWIND}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BRAVE_BIRD, MOVE_STEEL_WING, MOVE_TAILWIND, MOVE_ROOST}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_DRAGON_CLAW, MOVE_REST, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza2[] = {
    ...
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza3[] = {
    ...
    .moves = {MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_ENERGY_BALL, MOVE_TEETER_DANCE}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace2[] = {
    ...
    .species = SPECIES_POLITOED,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_SCALD, MOVE_ICY_WIND, MOVE_HYPNOSIS, MOVE_EARTH_POWER}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_AQUA_TAIL, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SCALD, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_FAKE_OUT}
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SCALD, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_SERPENT_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace4[] = {
    ...
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_STONE_EDGE, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jayce[] = {
    {
    .iv = 100,
    .lvl = 46,
    .species = SPECIES_SHELGON,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Gabrielle[] = {
    {
    .iv = 0,
    .lvl = 48,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Camina[] = {
    {
    .iv = 10,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_MayPostGameTreecko[] = {
    ...
    .moves = {MOVE_BRAVE_BIRD, MOVE_ENDEAVOR, MOVE_REVERSAL, MOVE_FACADE},
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_THUNDERBOLT, MOVE_CHARGE_BEAM, MOVE_FOCUS_BLAST, MOVE_LIGHT_SCREEN},
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_PSYCHIC, MOVE_SIGNAL_BEAM, MOVE_SHADOW_BALL, MOVE_MORNING_SUN},
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_WATER_PULSE, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE, MOVE_DARK_PULSE},
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FLARE_BLITZ, MOVE_SKY_UPPERCUT, MOVE_ROCK_SLIDE, MOVE_PROTECT},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayPostGameTorchic[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_DRAINING_KISS, MOVE_CALM_MIND},
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_FOCUS_BLAST, MOVE_ERUPTION, MOVE_SOLAR_BEAM},
    },
    {
    .iv = 255,
    .lvl = 64,
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_MUSCLE_BAND,
    .moves = {MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_HAMMER_ARM, MOVE_AVALANCHE},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayPostGameMudkip[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FOUL_PLAY, MOVE_CONFUSE_RAY, MOVE_PSYCH_UP, MOVE_MOONLIGHT},
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .heldItem = ITEM_POWER_HERB,
    .moves = {MOVE_HEAT_WAVE, MOVE_DRAGON_PULSE, MOVE_SOLAR_BEAM, MOVE_TAILWIND},
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .species = SPECIES_SCEPTILE,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_LEAF_BLADE, MOVE_NIGHT_SLASH, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE},
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Holden[] = {
    {
    .iv = 220,
    .lvl = 54,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Nagata[] = {
    {
    .iv = 220,
    .lvl = 54,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cece[] = {
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_SPOINK,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Franny[] = {
    {
    .iv = 0,
    .lvl = 20,
    .species = SPECIES_KIRLIA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Meggi[] = {
    {
    .iv = 0,
    .lvl = 52,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Momo1[] = {
    {
    .iv = 0,
    .lvl = 31,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Momo2[] = {
    {
    .iv = 0,
    .lvl = 37,
    .species = SPECIES_WIGGLYTUFF,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Momo3[] = {
    {
    .iv = 0,
    .lvl = 40,
    .species = SPECIES_WIGGLYTUFF,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Momo4[] = {
    {
    .iv = 0,
    .lvl = 43,
    .species = SPECIES_WIGGLYTUFF,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Momo5[] = {
    {
    .iv = 0,
    .lvl = 47,
    .species = SPECIES_WIGGLYTUFF,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Nellie[] = {
    {
    .iv = 0,
    .lvl = 20,
    .species = SPECIES_SKITTY,
...
static const struct TrainerMonNoItemCustomMoves sParty_AliAndLily[] = {
    {
    .iv = 200,
    .lvl = 54,
    .species = SPECIES_HITMONCHAN,
    ...
    .lvl = 54,
    .species = SPECIES_HITMONLEE,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_BLAZE_KICK, MOVE_MEGA_KICK, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Andres[] = {
    {
    .iv = 0,
    .lvl = 45,
    .species = SPECIES_ALTARIA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ripley[] = {
    {
    .iv = 200,
    .lvl = 53,
