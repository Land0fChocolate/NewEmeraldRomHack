...
static const struct TrainerMonItemCustomMoves sParty_Matt[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_SNARL, MOVE_DIG},
    },
    {
    .iv = 50,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Juan[] = { //TODO: make an event in Evergrande where you fight Juan.
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_PELIPPER,
