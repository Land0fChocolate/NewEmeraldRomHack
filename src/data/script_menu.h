...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_OLDALE_STARTERS_HOENN]      = MULTICHOICE(MultichoiceList_StartersHoenn),
    [MULTI_OLDALE_STARTERS_HOENN_KANTO] = MULTICHOICE(MultichoiceList_StartersHoennKanto),
    [MULTI_OLDALE_STARTERS_HOENN_JOHTO] = MULTICHOICE(MultichoiceList_StartersHoennJohto),
    [MULTI_OLDALE_STARTERS_ALL]         = MULTICHOICE(MultichoiceList_StartersAll),
    ...
    [MULTI_LEVEL_MODE_AG]              = MULTICHOICE(MultichoiceList_LevelModeAG),
};
