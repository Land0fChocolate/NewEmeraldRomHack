...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_OLD_GATEAU - ITEM_POTION]       = gItemEffect_Lemonade,
    [ITEM_CASTELIACONE - ITEM_POTION]     = gItemEffect_Ether,
    [ITEM_LUMIOSE_GALETTE - ITEM_POTION]  = gItemEffect_LeppaBerry,
