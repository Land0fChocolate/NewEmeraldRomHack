const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIDGEY]                = {{EVO_LEVEL, 17, SPECIES_PIDGEOTTO}},
    ...
    [SPECIES_SPEAROW]               = {{EVO_LEVEL, 22, SPECIES_FEAROW}},
    [SPECIES_EKANS]                 = {{EVO_LEVEL, 22, SPECIES_ARBOK}},
    [SPECIES_PIKACHU]               = {{EVO_TRADE_ITEM, ITEM_BIG_MALASADA, SPECIES_RAICHU_ALOLAN},
    ...
    [SPECIES_DIGLETT]               = {{EVO_LEVEL, 27, SPECIES_DUGTRIO}},
    [SPECIES_MEOWTH]                = {{EVO_LEVEL, 26, SPECIES_PERSIAN}},
    [SPECIES_PSYDUCK]               = {{EVO_LEVEL, 24, SPECIES_GOLDUCK}},
    [SPECIES_MANKEY]                = {{EVO_LEVEL, 27, SPECIES_PRIMEAPE}},
    ...
    [SPECIES_BELLSPROUT]            = {{EVO_LEVEL, 18, SPECIES_WEEPINBELL}},
    [SPECIES_WEEPINBELL]            = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VICTREEBEL}},
    [SPECIES_TENTACOOL]             = {{EVO_LEVEL, 28, SPECIES_TENTACRUEL}},
    ...
    [SPECIES_MAGNEMITE]             = {{EVO_LEVEL, 27, SPECIES_MAGNETON}},
    [SPECIES_MAGNETON]              = {{EVO_MAPSEC, MAPSEC_METEOR_FALLS, SPECIES_MAGNEZONE},
                                        {EVO_MAPSEC, MAPSEC_METEOR_FALLS2, SPECIES_MAGNEZONE},
                                        {EVO_MAPSEC, MAPSEC_VICTORY_ROAD, SPECIES_MAGNEZONE}},
    [SPECIES_DODUO]                 = {{EVO_LEVEL, 27, SPECIES_DODRIO}},
    [SPECIES_SEEL]                  = {{EVO_LEVEL, 28, SPECIES_DEWGONG}},
    [SPECIES_GRIMER]                = {{EVO_LEVEL, 28, SPECIES_MUK}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_TRADE_ITEM, ITEM_BIG_MALASADA, SPECIES_EXEGGUTOR_ALOLAN},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR}},
    [SPECIES_CUBONE]                = {{EVO_TRADE_ITEM, ITEM_BIG_MALASADA, SPECIES_MAROWAK_ALOLAN},
                                       {EVO_LEVEL, 26, SPECIES_MAROWAK}},
    [SPECIES_LICKITUNG]             = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]               = {{EVO_TRADE_ITEM, ITEM_GALAR_CURRY, SPECIES_WEEZING_GALARIAN},
    ...
    [SPECIES_SCYTHER]               = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                                       {EVO_TRADE_ITEM, ITEM_BLACK_AUGURITE, SPECIES_KLEAVOR}},
    ...
    [SPECIES_QUILAVA]               = {{EVO_LEVEL, 40, SPECIES_TYPHLOSION},
                                       {EVO_TRADE_ITEM, ITEM_OLD_GATEAU, SPECIES_TYPHLOSION_HISUIAN}},
    ...
    [SPECIES_HOOTHOOT]              = {{EVO_LEVEL, 19, SPECIES_NOCTOWL}},
    ...
    [SPECIES_MAREEP]                = {{EVO_LEVEL, 16, SPECIES_FLAAFFY}},
    ...
    [SPECIES_SKIPLOOM]              = {{EVO_LEVEL, 29, SPECIES_JUMPLUFF}},
    ...
    [SPECIES_TEDDIURSA]             = {{EVO_LEVEL, 29, SPECIES_URSARING}},
    [SPECIES_URSARING]              = {{EVO_TRADE_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA}},
    [SPECIES_SLUGMA]                = {{EVO_LEVEL, 26, SPECIES_MAGCARGO}},
    ...
    [SPECIES_TAILLOW]               = {{EVO_LEVEL, 24, SPECIES_SWELLOW}},
    ...
    [SPECIES_NOSEPASS]              = {{EVO_MAPSEC, MAPSEC_METEOR_FALLS, SPECIES_PROBOPASS},
                                        {EVO_MAPSEC, MAPSEC_METEOR_FALLS2, SPECIES_PROBOPASS},
                                        {EVO_MAPSEC, MAPSEC_VICTORY_ROAD, SPECIES_PROBOPASS}},
    [SPECIES_SABLEYE]               = {{EVO_MEGA_EVOLUTION, ITEM_SABLENITE, SPECIES_SABLEYE_MEGA}},
    [SPECIES_BARBOACH]              = {{EVO_LEVEL, 28, SPECIES_WHISCASH}},
    [SPECIES_CORPHISH]              = {{EVO_LEVEL, 28, SPECIES_CRAWDAUNT}},
    ...
    [SPECIES_SEALEO]                = {{EVO_LEVEL, 42, SPECIES_WALREIN}},
    [SPECIES_CACNEA]                = {{EVO_LEVEL, 32, SPECIES_CACTURNE}},
    [SPECIES_SNORUNT]               = {{EVO_LEVEL, 34, SPECIES_GLALIE},
    ...
    [SPECIES_MEDITITE]              = {{EVO_LEVEL, 27, SPECIES_MEDICHAM}},
    ...
    [SPECIES_ARON]                  = {{EVO_LEVEL, 22, SPECIES_LAIRON}},
    [SPECIES_LAIRON]                = {{EVO_LEVEL, 42, SPECIES_AGGRON}},
    [SPECIES_AGGRON]                = {{EVO_MEGA_EVOLUTION, ITEM_AGGRONITE, SPECIES_AGGRON_MEGA}},
    [SPECIES_LILEEP]                = {{EVO_LEVEL, 34, SPECIES_CRADILY}},
    [SPECIES_ANORITH]               = {{EVO_LEVEL, 38, SPECIES_ARMALDO}},
    ...
    [SPECIES_GLAMEOW]               = {{EVO_LEVEL, 27, SPECIES_PURUGLY}},
    [SPECIES_CHINGLING]             = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_CHIMECHO}},
    [SPECIES_STUNKY]                = {{EVO_LEVEL, 29, SPECIES_SKUNTANK}},
    [SPECIES_BRONZOR]               = {{EVO_LEVEL, 31, SPECIES_BRONZONG}},
    ...
    [SPECIES_HIPPOPOTAS]            = {{EVO_LEVEL, 32, SPECIES_HIPPOWDON}},
    [SPECIES_SKORUPI]               = {{EVO_LEVEL, 32, SPECIES_DRAPION}},
    [SPECIES_CROAGUNK]              = {{EVO_LEVEL, 30, SPECIES_TOXICROAK}},
    [SPECIES_FINNEON]               = {{EVO_LEVEL, 24, SPECIES_LUMINEON}},
    ...
    [SPECIES_PIDOVE]                = {{EVO_LEVEL, 18, SPECIES_TRANQUILL}},
    ...
    [SPECIES_TYMPOLE]               = {{EVO_LEVEL, 14, SPECIES_PALPITOAD}},
    [SPECIES_PALPITOAD]             = {{EVO_LEVEL, 32, SPECIES_SEISMITOAD}},
    ...
    [SPECIES_SANDILE]               = {{EVO_LEVEL, 19, SPECIES_KROKOROK}},
    [SPECIES_KROKOROK]              = {{EVO_LEVEL, 38, SPECIES_KROOKODILE}},
    [SPECIES_DARUMAKA]              = {{EVO_LEVEL, 31, SPECIES_DARMANITAN}},
    [SPECIES_DWEBBLE]               = {{EVO_LEVEL, 28, SPECIES_CRUSTLE}},
    [SPECIES_SCRAGGY]               = {{EVO_LEVEL, 29, SPECIES_SCRAFTY}},
    [SPECIES_YAMASK]                = {{EVO_LEVEL, 28, SPECIES_COFAGRIGUS}},
    [SPECIES_TIRTOUGA]              = {{EVO_LEVEL, 35, SPECIES_CARRACOSTA}},
    [SPECIES_ARCHEN]                = {{EVO_LEVEL, 35, SPECIES_ARCHEOPS}},
    [SPECIES_TRUBBISH]              = {{EVO_LEVEL, 31, SPECIES_GARBODOR}},
    [SPECIES_ZORUA]                 = {{EVO_LEVEL, 30, SPECIES_ZOROARK}},
    [SPECIES_MINCCINO]              = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_CINCCINO}},
    [SPECIES_GOTHITA]               = {{EVO_LEVEL, 19, SPECIES_GOTHORITA}},
    [SPECIES_GOTHORITA]             = {{EVO_LEVEL, 38, SPECIES_GOTHITELLE}},
    [SPECIES_SOLOSIS]               = {{EVO_LEVEL, 19, SPECIES_DUOSION}},
    [SPECIES_DUOSION]               = {{EVO_LEVEL, 38, SPECIES_REUNICLUS}},
    [SPECIES_DUCKLETT]              = {{EVO_LEVEL, 25, SPECIES_SWANNA}},
    [SPECIES_VANILLITE]             = {{EVO_LEVEL, 18, SPECIES_VANILLISH}},
    [SPECIES_VANILLISH]             = {{EVO_LEVEL, 39, SPECIES_VANILLUXE}},
    [SPECIES_DEERLING]              = {{EVO_LEVEL, 26, SPECIES_SAWSBUCK}},
    [SPECIES_KARRABLAST]            = {{EVO_TRADE_SPECIFIC_MON, SPECIES_SHELMET, SPECIES_ESCAVALIER}},
    [SPECIES_FOONGUS]               = {{EVO_LEVEL, 26, SPECIES_AMOONGUSS}},
    [SPECIES_FRILLISH]              = {{EVO_LEVEL, 30, SPECIES_JELLICENT}},
    [SPECIES_JOLTIK]                = {{EVO_LEVEL, 27, SPECIES_GALVANTULA}},
    [SPECIES_FERROSEED]             = {{EVO_LEVEL, 34, SPECIES_FERROTHORN}},
    [SPECIES_KLINK]                 = {{EVO_LEVEL, 22, SPECIES_KLANG}},
    [SPECIES_KLANG]                 = {{EVO_LEVEL, 38, SPECIES_KLINKLANG}},
    [SPECIES_TYNAMO]                = {{EVO_LEVEL, 27, SPECIES_EELEKTRIK}},
    [SPECIES_EELEKTRIK]             = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_EELEKTROSS}},
    [SPECIES_ELGYEM]                = {{EVO_LEVEL, 25, SPECIES_BEHEEYEM}},
    ...
    [SPECIES_FRAXURE]               = {{EVO_LEVEL, 43, SPECIES_HAXORUS}},
    [SPECIES_CUBCHOO]               = {{EVO_LEVEL, 31, SPECIES_BEARTIC}},
    [SPECIES_SHELMET]               = {{EVO_TRADE_SPECIFIC_MON, SPECIES_KARRABLAST, SPECIES_ACCELGOR}},
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 32, SPECIES_MIENSHAO}},
    ...
    [SPECIES_LARVESTA]              = {{EVO_LEVEL, 42, SPECIES_VOLCARONA}},
    ...
    [SPECIES_SKRELP]                = {{EVO_LEVEL, 34, SPECIES_DRAGALGE}},
    ...
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 32, SPECIES_AVALUGG}},
    [SPECIES_NOIBAT]                = {{EVO_LEVEL, 35, SPECIES_NOIVERN}},
    ...
    [SPECIES_MAREANIE]              = {{EVO_LEVEL, 31, SPECIES_TOXAPEX}},
    [SPECIES_MUDBRAY]               = {{EVO_LEVEL, 30, SPECIES_MUDSDALE}},
    [SPECIES_DEWPIDER]              = {{EVO_LEVEL, 22, SPECIES_ARAQUANID}},
    [SPECIES_FOMANTIS]              = {{EVO_LEVEL_DAY, 28, SPECIES_LURANTIS}},
    ...
    [SPECIES_COSMOG]                = {{EVO_LEVEL, 40, SPECIES_COSMOEM}},
    [SPECIES_COSMOEM]               = {{EVO_LEVEL_DAY, 60, SPECIES_SOLGALEO},
                                       {EVO_LEVEL_NIGHT, 60, SPECIES_LUNALA}},
    ...
    [SPECIES_TOXEL]                 = {{EVO_LEVEL_NATURE_AMPED, 26, SPECIES_TOXTRICITY},
                                       {EVO_LEVEL_NATURE_LOW_KEY, 26, SPECIES_TOXTRICITY_LOW_KEY}},
    ...
    [SPECIES_HATENNA]               = {{EVO_LEVEL, 26, SPECIES_HATTREM}},
    [SPECIES_HATTREM]               = {{EVO_LEVEL, 42, SPECIES_HATTERENE}},
    [SPECIES_IMPIDIMP]              = {{EVO_LEVEL, 26, SPECIES_MORGREM}},
    ...
    [SPECIES_DREEPY]                = {{EVO_LEVEL, 25, SPECIES_DRAKLOAK}},
    [SPECIES_DRAKLOAK]              = {{EVO_LEVEL, 45, SPECIES_DRAGAPULT}},
    ...
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_CRITICAL_HITS, 0, SPECIES_SIRFETCHD}},
    ...
    [SPECIES_YAMASK_GALARIAN]       = {{EVO_SCRIPT_TRIGGER_DMG, 0, SPECIES_RUNERIGUS}},
