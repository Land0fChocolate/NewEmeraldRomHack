const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_LEADER_WALLACE] = TRAINER_PIC_CHAMPION_WALLACE,
    ...
    [FACILITY_CLASS_LORE_KEEPER_ZINNIA] = TRAINER_PIC_ZINNIA,
    ...
    [FACILITY_CLASS_FAIRY_TALE_GIRL] = TRAINER_PIC_FAIRY_TALE_GIRL,
    [FACILITY_CLASS_DELINQUENT] = TRAINER_PIC_DELINQUENT,
    [FACILITY_CLASS_STREET_THUG] = TRAINER_PIC_STREET_THUG,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_LEADER_WALLACE] = TRAINER_CLASS_LEADER,
    ...
    [FACILITY_CLASS_LORE_KEEPER_ZINNIA] = TRAINER_CLASS_LORE_KEEPER,
    ...
    [FACILITY_CLASS_FAIRY_TALE_GIRL] = TRAINER_CLASS_FAIRY_TALE_GIRL,
    [FACILITY_CLASS_DELINQUENT] = TRAINER_CLASS_DELINQUENT,
    [FACILITY_CLASS_STREET_THUG] = TRAINER_CLASS_STREET_THUG,
};
