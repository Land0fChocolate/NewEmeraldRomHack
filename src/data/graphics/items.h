...
const u32 gItemIcon_SpaceBelt[] = INCBIN_U32("graphics/items/icons/space_belt.4bpp.lz");
const u32 gItemIconPalette_SpaceBelt[] = INCBIN_U32("graphics/items/icon_palettes/space_belt.gbapal.lz");
...
const u32 gItemIcon_OriginStrand[] = INCBIN_U32("graphics/items/icons/origin_strand.4bpp.lz");
const u32 gItemIconPalette_OriginStrand[] = INCBIN_U32("graphics/items/icon_palettes/origin_strand.gbapal.lz");
