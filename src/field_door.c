...
static const u8 sDoorAnimTiles_EverGrande[] = INCBIN_U8("graphics/door_anims/evergrande.4bpp");
static const u16 sDoorNullPalette50[16] = {};
static const u8 sDoorAnimTiles_DraconidArchives[] = INCBIN_U8("graphics/door_anims/draconid_archives.4bpp");
...
static const u8 sDoorAnimPalettes_EverGrande[] = {8, 8, 8, 8, 8, 8, 8, 8};
static const u8 sDoorAnimPalettes_DraconidArchives[] = {12, 12, 12, 12, 12, 12, 12, 12};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_EverGrande_Door_BattleTent,                   DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_BattleTent, sDoorAnimPalettes_BattleTent},
    ...
    {METATILE_EverGrande_Door,                              DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_EverGrande, sDoorAnimPalettes_EverGrande},
    {METATILE_Fallarbor_Door_DraconidArchives,              DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_DraconidArchives, sDoorAnimPalettes_DraconidArchives},
    {},
};
