...
u8 AbilityBattleEffects(u8 caseID, u8 battlerId, u8 special, u16 moveArg);
...
u16 CalcPartyMonTypeEffectivenessMultiplier(u16 move, u16 speciesDef, u16 defAbilities[]);
