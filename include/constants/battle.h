...
#define SIDE_STATUS_HIDDEN_THORNS           (1 << 22)
#define SIDE_STATUS_HIDDEN_THORNS_DAMAGED   (1 << 23)
#define SIDE_STATUS_TIME_TRAVELLED          (1 << 24)

#define SIDE_STATUS_HAZARDS_ANY    (SIDE_STATUS_SPIKES | SIDE_STATUS_STICKY_WEB | SIDE_STATUS_TOXIC_SPIKES | SIDE_STATUS_STEALTH_ROCK | SIDE_STATUS_HIDDEN_THORNS)
...
#define MOVE_EFFECT_ROUND               0x4B
#define MOVE_EFFECT_STEALTH_ROCK        0x4C
