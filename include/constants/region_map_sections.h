...
#define MAPSEC_CRUMBLING_GORGE              0xD5
#define MAPSEC_OLDALE_FARM                  0xD6
#define MAPSEC_LITTLEROOT_BEACH             0xD7
...
#define MAPSEC_LUSTROUS_LAIR                0xDC
#define MAPSEC_DERELICT_DEN                 0xDD
#define MAPSEC_FIERY_THRONE                 0xDE
