...
#define FLAG_SWORDMASTER_BOOST                    (1 << 28)
...
#define HIDDEN_COMMAND_NONE        0
#define HIDDEN_COMMAND_CUT         1
#define HIDDEN_COMMAND_FLY         2
#define HIDDEN_COMMAND_SURF        3
#define HIDDEN_COMMAND_STRENGTH    4
#define HIDDEN_COMMAND_FLASH       5
#define HIDDEN_COMMAND_ROCK_SMASH  6
#define HIDDEN_COMMAND_WATERFALL   7
#define HIDDEN_COMMAND_DIVE        8
