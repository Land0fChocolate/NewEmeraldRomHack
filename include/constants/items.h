...
#define FIRST_XXX_BERRY       ITEM_LIECHI_BERRY
#define LAST_XXX_BERRY        ITEM_STARF_BERRY
...
#define NUM_XXX_BERRIES           (LAST_XXX_BERRY - FIRST_XXX_BERRY + 1)
#define NUM_XXX_BERRIES_SKIPPED   (FIRST_XXX_BERRY - FIRST_BERRY_INDEX)
