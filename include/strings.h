...
extern const u8 gText_TextSpeedVFast[];
...
extern const u8 gText_BattleBagUseVanilla[];
extern const u8 gText_BattleBagUsePokeBallsOnly[];
...
extern const u8 gText_BattleBagUse[];
...
extern const u8 gBirchDexRatingText_LessThan211[];
...
extern const u8 gText_KissPoster8BP[];
extern const u8 gText_KissCushion16BP[];
extern const u8 gText_SmoochumDoll24BP[];
extern const u8 gText_MeowthDoll24BP[];
extern const u8 gText_ClefairyDoll24BP[];
extern const u8 gText_TogepiDoll32BP[];
extern const u8 gText_DittoDoll32BP[];
extern const u8 gText_CyndaquilDoll40BP[];
extern const u8 gText_ChikoritaDoll40BP[];
extern const u8 gText_TotodileDoll40BP[];

extern const u8 gText_LaprasDoll96BP[];
extern const u8 gText_SnorlaxDoll96BP[];
extern const u8 gText_VenusaurDoll128BP[];
extern const u8 gText_CharizardDoll128BP[];
extern const u8 gText_BlastoiseDoll128BP[];
extern const u8 gText_RegirockDoll160BP[];
...
extern const u8 gText_Protector10BP[];
extern const u8 gText_Electirizer10BP[];
extern const u8 gText_Magmarizer10BP[];
extern const u8 gText_DeepSeaScale10BP[];
extern const u8 gText_DeepSeaTooth10BP[];
extern const u8 gText_DragonScale10BP[];
extern const u8 gText_UpGrade10BP[];
extern const u8 gText_DubiousDisc10BP[];
extern const u8 gText_KingsRock16BP[];
extern const u8 gText_RazorClaw16BP[];
extern const u8 gText_RazorFang16BP[];
...
extern const u8 gText_AdrenalineOrb12BP[];
extern const u8 gText_RedCard12BP[];
extern const u8 gText_DestinyKnot12BP[];
extern const u8 gText_ShedShell12BP[];
extern const u8 gText_StickyBarb12BP[];
extern const u8 gText_ExpertBelt20BP[];
extern const u8 gText_QuickClaw20BP[];
extern const u8 gText_Snowball20BP[];
extern const u8 gText_LightClay20BP[];
extern const u8 gText_BlackSludge20BP[];
extern const u8 gText_WiseGlasses20BP[];
extern const u8 gText_MuscleBand20BP[];
extern const u8 gText_Eviolite20BP[];
extern const u8 gText_WeaknessPolicy24BP[];
extern const u8 gText_BlunderPolicy24BP[];
extern const u8 gText_Leftovers32BP[];
extern const u8 gText_AirBalloon32BP[];
extern const u8 gText_ChoiceBand32BP[];
extern const u8 gText_ChoiceSpecs32BP[];
extern const u8 gText_ChoiceScarf32BP[];
extern const u8 gText_FocusSash32BP[];
extern const u8 gText_LifeOrb32BP[];
...
extern const u8 gText_Trick4BP[];
extern const u8 gText_WorrySeed4BP[];
extern const u8 gText_Softboiled6BP[];
extern const u8 gText_WorkUp6BP[];
extern const u8 gText_Defog6BP[];
extern const u8 gText_Counter6BP[];
extern const u8 gText_MagicCoat6BP[];
extern const u8 gText_DreamEater8BP[];
extern const u8 gText_LowKick8BP[];
extern const u8 gText_SeismicToss8BP[];
extern const u8 gText_MegaPunch8BP[];
extern const u8 gText_MegaKick8BP[];
extern const u8 gText_BodySlam12BP[];
extern const u8 gText_RockSlide12BP[];
extern const u8 gText_SwordsDance16BP[];
extern const u8 gText_KnockOff16BP[];
extern const u8 gText_PsychicFang16BP[];
extern const u8 gText_StealthRock16BP[];
extern const u8 gText_SeedBomb16BP[];
extern const u8 gText_BlazeImpact16BP[];
extern const u8 gText_PlayRough20BP[];
extern const u8 gText_AquaTail20BP[];
extern const u8 gText_FoulPlay20BP[];
extern const u8 gText_Megahorn20BP[];
extern const u8 gText_Superpower20BP[];
extern const u8 gText_DefenseCurl4BP[];
extern const u8 gText_Snore4BP[];
extern const u8 gText_Swift4BP[];
extern const u8 gText_PainSplit6BP[];
extern const u8 gText_Recycle6BP[];
extern const u8 gText_IcyWind8BP[];
extern const u8 gText_Endure8BP[];
extern const u8 gText_PsychUp8BP[];
extern const u8 gText_LowSweep8BP[];
extern const u8 gText_BreakingSwipe8BP[];
extern const u8 gText_BugBite12BP[];
extern const u8 gText_SerpentDance12BP[];
extern const u8 gText_Tailwind12BP[];
extern const u8 gText_StoredPower12BP[];
extern const u8 gText_Avalanche12BP[];
extern const u8 gText_IronHead16BP[];
extern const u8 gText_HiddenThorns16BP[];
extern const u8 gText_IcePunch16BP[];
extern const u8 gText_ThunderPunch16BP[];
extern const u8 gText_FirePunch16BP[];
extern const u8 gText_FlintBlade16BP[];
extern const u8 gText_SignalBeam16BP[];
extern const u8 gText_ZenHeadbutt16BP[];
extern const u8 gText_HeatWave16BP[];
extern const u8 gText_EarthPower20BP[];
extern const u8 gText_BodyPress20BP[];
extern const u8 gText_GunkShot20BP[];
extern const u8 gText_NastyPlot20BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AdrenalineOrbDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ShedShellDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SnowballDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_MagicCoatDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_BlazeImpactDesc[];
extern const u8 BattleFrontier_Lounge7_Text_TrickDesc[];
extern const u8 BattleFrontier_Lounge7_Text_WorrySeedDesc[];
extern const u8 BattleFrontier_Lounge7_Text_WorkUpDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_PsychicFangsDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_PlayRoughDesc[];
extern const u8 BattleFrontier_Lounge7_Text_AquaTailDesc[];
extern const u8 BattleFrontier_Lounge7_Text_FoulPlayDesc[];
extern const u8 BattleFrontier_Lounge7_Text_MegahornDesc[];
extern const u8 BattleFrontier_Lounge7_Text_SuperpowerDesc[];
extern const u8 BattleFrontier_Lounge7_Text_PainSplitDesc[];
extern const u8 BattleFrontier_Lounge7_Text_RecycleDesc[];
extern const u8 BattleFrontier_Lounge7_Text_LowSweepDesc[];
extern const u8 BattleFrontier_Lounge7_Text_BreakingSwipeDesc[];
extern const u8 BattleFrontier_Lounge7_Text_TailwindDesc[];
extern const u8 BattleFrontier_Lounge7_Text_StoredPowerDesc[];
extern const u8 BattleFrontier_Lounge7_Text_AvalancheDesc[];
extern const u8 BattleFrontier_Lounge7_Text_HiddenThornsDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_EarthPowerDesc[];
extern const u8 BattleFrontier_Lounge7_Text_BodyPressDesc[];
...
extern const u8 gText_AlreadyHaveItem[];
...
extern const u8 gTrickHouse_Mechadoll_Seedot[];
...
extern const u8 gTrickHouse_Mechadoll_100Yen[];
extern const u8 gTrickHouse_Mechadoll_50Yen[];
...
extern const u8 gText_ChilanBerry[];
extern const u8 gText_OccaBerry[];
extern const u8 gText_PasshoBerry[];
extern const u8 gText_WacanBerry[];
extern const u8 gText_RindoBerry[];
extern const u8 gText_YacheBerry[];
extern const u8 gText_ChopleBerry[];
extern const u8 gText_KebiaBerry[];
extern const u8 gText_ShucaBerry[];
extern const u8 gText_CobaBerry[];
extern const u8 gText_PayapaBerry[];
extern const u8 gText_TangaBerry[];
extern const u8 gText_ChartiBerry[];
extern const u8 gText_KasibBerry[];
extern const u8 gText_HabanBerry[];
extern const u8 gText_ColburBerry[];
extern const u8 gText_BabiriBerry[];
extern const u8 gText_RoseliBerry[];
...
//Mega Stones
extern const u8 gText_Venusaurite[];
extern const u8 gText_CharizarditeX[];
extern const u8 gText_CharizarditeY[];
extern const u8 gText_Blastoisinite[];
extern const u8 gText_Beedrillite[];
extern const u8 gText_Pidgeotite[];
extern const u8 gText_Alakazite[];
extern const u8 gText_Slowbronite[];
extern const u8 gText_Gengarite[];
extern const u8 gText_Kangaskhanite[];
extern const u8 gText_Pinsirite[];
extern const u8 gText_Gyaradosite[];
extern const u8 gText_Aerodactylite[];
extern const u8 gText_MewtwoniteX[];
extern const u8 gText_MewtwoniteY[];
extern const u8 gText_Ampharosite[];
extern const u8 gText_Steelixite[];
extern const u8 gText_Scizorite[];
extern const u8 gText_Heracronite[];
extern const u8 gText_Houndoominite[];
extern const u8 gText_Tyranitarite[];
extern const u8 gText_Sceptilite[];
extern const u8 gText_Blazikenite[];
extern const u8 gText_Swampertite[];
extern const u8 gText_Gardevoirite[];
extern const u8 gText_Galladite[];
extern const u8 gText_Sablenite[];
extern const u8 gText_Mawilite[];
extern const u8 gText_Aggronite[];
extern const u8 gText_Medichamite[];
extern const u8 gText_Manectite[];
extern const u8 gText_Sharpedonite[];
extern const u8 gText_Cameruptite[];
extern const u8 gText_Altarianite[];
extern const u8 gText_Banettite[];
extern const u8 gText_Absolite[];
extern const u8 gText_Glalitite[];
extern const u8 gText_Salamencite[];
extern const u8 gText_Metagrossite[];
extern const u8 gText_Latiasite[];
extern const u8 gText_Latiosite[];
...
extern const u8 BattleDome_Text_StyleUsesHighRiskHighPowerMoves[];
...
extern const u8 BattleDome_Text_StyleStrongMovesEffects[];
...
extern const u8 MatchCall_Text_Wallace1[];
extern const u8 MatchCall_Text_Wallace2[];
extern const u8 MatchCall_Text_Wallace3[];
extern const u8 MatchCall_Text_Wallace4[];
extern const u8 MatchCall_Text_Juan[];
extern const u8 MatchCall_Text_Sidney[];
extern const u8 MatchCall_Text_Phoebe[];
extern const u8 MatchCall_Text_Glacia[];
extern const u8 MatchCall_Text_Drake[];
extern const u8 MatchCall_Text_Steven[];
extern const u8 MatchCall_Text_Zinnia1[];
extern const u8 MatchCall_Text_Zinnia2[];
...
extern const u8 gText_ZinniaMatchCallDesc[];
extern const u8 gText_ZinniaMatchCallName[];
...
extern const u8 gText_LoreKeeperMatchCallDesc[];
...
extern const u8 gText_MatchCallSteven_Intro1[];
extern const u8 gText_MatchCallSteven_Intro2[];
