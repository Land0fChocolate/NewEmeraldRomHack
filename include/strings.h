...
extern const u8 gText_AdrenalineOrb16BP[];
extern const u8 gText_RedCard16BP[];
extern const u8 gText_DestinyKnot16BP[];
extern const u8 gText_Metronome16BP[];
extern const u8 gText_ShedShell16BP[];
extern const u8 gText_StickyBarb16BP[];
extern const u8 gText_LaggingTail16BP[];
extern const u8 gText_QuickClaw24BP[];
extern const u8 gText_Snowball24BP[];
extern const u8 gText_LightClay24BP[];
extern const u8 gText_BlackSludge24BP[];
extern const u8 gText_WiseGlasses24BP[];
extern const u8 gText_MuscleBand24BP[];
extern const u8 gText_HeatRock24BP[];
extern const u8 gText_DampRock24BP[];
extern const u8 gText_SmoothRock24BP[];
extern const u8 gText_IcyRock24BP[];
